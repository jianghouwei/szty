package com.szty.commos.shiro.utils;
...
public final class EndecryptUtils {
	...
	// SecureRandomNumberGenerator secureRandomNumberGenerator = new
	// SecureRandomNumberGenerator();
	// String salt = secureRandomNumberGenerator.nextBytes().toHex();
	// // 组合username,两次迭代，对密码进行加密
	// String password_cipherText = new Md5Hash(password, username + salt,
	// 2).toBase64();
	// User user = new User();
	...
	public static void main(String[] args) {
		...
		System.out.println("通过md5加密之后的密文是"+md5Password("123123"));

<%@page import=" com.szty.aihaonew.JspFileUploadLimageA"%>
...
<body>
	<%
		JspFileUploadLimageA up = new JspFileUploadLimageA();
		up.setRequest(request);
		up.setUploadPath(PropertyUtils.getValue("uploadfile"));
		int j = up.process();
	%>

	<form enctype="multipart/form-data" name="form1" method="post">
		<input type="hidden" name="count" id="count" value="1" /> <input
			name="dvalue" type="hidden" id="dvalue" value="<%=up.getUrlStr()%>" />

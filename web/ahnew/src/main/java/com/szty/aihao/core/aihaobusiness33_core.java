...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness33_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness33(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness33_Dao get_aihaobusiness33Dao(int _sname) throws Exception;

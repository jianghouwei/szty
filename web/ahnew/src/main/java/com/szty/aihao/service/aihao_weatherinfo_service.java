...
import java.util.List;
    ...
    /**
    *@文件说明
    *@AIHAO_WEATHERINFO逻辑层接口
    *@作者：宋春林 
    */

	public class aihao_weatherinfo_service
	{
        public  aihao_weatherinfo_core _dal=classFactory.getaihao_weatherinfo();
		...
		public int insert_aihao_weatherinfo (aihao_weatherinfo_Dao _AIHAO_WEATHERINFOModel )  throws Exception{
         return _dal.insert_aihao_weatherinfo( _AIHAO_WEATHERINFOModel);
		}
        ...
        return _dal.insert_aihao_weatherinfo( _para);
        }
        ...
        return _dal.update_aihao_weatherinfo( _AIHAO_WEATHERINFOModel);
		}
        ...
        return _dal.delete_aihao_weatherinfo( Wid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_aihao_weatherinfoDao( Wid);
		}
        ...
        * @throws Exception 
		...
		public List<aihao_weatherinfo_Dao> get_aihao_weatherinfo_All() throws Exception{
            return _dal.get_aihao_weatherinfo_All();
            }
		    /**
         * 根据AIHAO_WEATHERINFO返回的查询DataRow创建一个AIHAO_WEATHERINFOEntity对象
         * @param AIHAO_WEATHERINFO row
        ...
        * @throws Exception 
		...
		public List<aihao_weatherinfo_Dao> get_aihao_weatherinfo_All(String strWhere) throws Exception{
            return _dal.get_aihao_weatherinfo_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<aihao_weatherinfo_Dao> get_aihao_weatherinfo_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_aihao_weatherinfo_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据AIHAO_WEATHERINFO返回的查询DataRow创建一个AIHAO_WEATHERINFOEntity对象
         * @param AIHAO_WEATHERINFO row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, aihao_weatherinfo_Dao> get_aihao_weatherinfo_Dictionary(String strWhere) throws Exception{
            return _dal.get_aihao_weatherinfo_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_aihao_weatherinfo_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_aihao_weatherinfo_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_aihao_weatherinfo_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_aihao_weatherinfo_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createaihao_weatherinfo_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_aihao_weatherinfo_UpdateString( FieldName, Value, sid);
            }

...
import java.util.List;
    ...
    */
	...
	public interface aihaosearchrecord_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaosearchrecord(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaosearchrecord_Dao get_aihaosearchrecordDao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface provinces_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_provinces(int _proname) throws Exception;
        ...
        * @throws Exception 
         */
		public provinces_Dao get_provincesDao(int _proname) throws Exception;

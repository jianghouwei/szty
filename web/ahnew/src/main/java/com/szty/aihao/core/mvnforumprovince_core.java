...
import java.util.List;
    ...
    */
	...
	public interface mvnforumprovince_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumprovince(int _proid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumprovince_Dao get_mvnforumprovinceDao(int _proid) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface winlist_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_winlist(int _winnerid) throws Exception;
        ...
        * @throws Exception 
         */
		public winlist_Dao get_winlistDao(int _winnerid) throws Exception;

...
import java.util.List;
    ...
    /**
    *@文件说明
    *@AIHAO18_20140409BAK逻辑层接口
    *@作者：宋春林 
    */

	public class aihao18_20140409bak_service
	{
        public  aihao18_20140409bak_core _dal=classFactory.getaihao18_20140409bak();
		...
		public int insert_aihao18_20140409bak (aihao18_20140409bak_Dao _AIHAO18_20140409BAKModel )  throws Exception{
         return _dal.insert_aihao18_20140409bak( _AIHAO18_20140409BAKModel);
		}
        ...
        return _dal.insert_aihao18_20140409bak( _para);
        }
        ...
        return _dal.update_aihao18_20140409bak( _AIHAO18_20140409BAKModel);
		}
        ...
        return _dal.delete_aihao18_20140409bak( Id);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_aihao18_20140409bakDao( Id);
		}
        ...
        * @throws Exception 
		...
		public List<aihao18_20140409bak_Dao> get_aihao18_20140409bak_All() throws Exception{
            return _dal.get_aihao18_20140409bak_All();
            }
		    /**
         * 根据AIHAO18_20140409BAK返回的查询DataRow创建一个AIHAO18_20140409BAKEntity对象
         * @param AIHAO18_20140409BAK row
        ...
        * @throws Exception 
		...
		public List<aihao18_20140409bak_Dao> get_aihao18_20140409bak_All(String strWhere) throws Exception{
            return _dal.get_aihao18_20140409bak_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<aihao18_20140409bak_Dao> get_aihao18_20140409bak_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_aihao18_20140409bak_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据AIHAO18_20140409BAK返回的查询DataRow创建一个AIHAO18_20140409BAKEntity对象
         * @param AIHAO18_20140409BAK row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, aihao18_20140409bak_Dao> get_aihao18_20140409bak_Dictionary(String strWhere) throws Exception{
            return _dal.get_aihao18_20140409bak_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_aihao18_20140409bak_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_aihao18_20140409bak_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_aihao18_20140409bak_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_aihao18_20140409bak_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createaihao18_20140409bak_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_aihao18_20140409bak_UpdateString( FieldName, Value, sid);
            }

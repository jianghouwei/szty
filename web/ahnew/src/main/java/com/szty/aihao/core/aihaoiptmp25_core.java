...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp25_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp25(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp25_Dao get_aihaoiptmp25Dao(int _id) throws Exception;

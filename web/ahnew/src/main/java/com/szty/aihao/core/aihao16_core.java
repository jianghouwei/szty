...
import java.util.List;
    ...
    */
	...
	public interface aihao16_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao16(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao16_Dao get_aihao16Dao(int _id) throws Exception;

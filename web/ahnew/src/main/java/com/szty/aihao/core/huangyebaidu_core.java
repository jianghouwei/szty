...
import java.util.List;
    ...
    */
	...
	public interface huangyebaidu_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_huangyebaidu(int _merid) throws Exception;
        ...
        * @throws Exception 
         */
		public huangyebaidu_Dao get_huangyebaiduDao(int _merid) throws Exception;

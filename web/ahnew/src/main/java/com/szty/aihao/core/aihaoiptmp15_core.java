...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp15_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp15(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp15_Dao get_aihaoiptmp15Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihao31_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao31(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao31_Dao get_aihao31Dao(int _id) throws Exception;

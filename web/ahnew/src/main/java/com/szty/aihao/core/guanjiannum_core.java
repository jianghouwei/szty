...
import java.util.List;
    ...
    */
	...
	public interface guanjiannum_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_guanjiannum(int _guanjiannum) throws Exception;
        ...
        * @throws Exception 
         */
		public guanjiannum_Dao get_guanjiannumDao(int _guanjiannum) throws Exception;

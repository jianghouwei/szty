...
import java.util.List;
    ...
    /**
    *@文件说明
    *@MVNFORUMMESSAGESTATISTICS逻辑层接口
    *@作者：宋春林 
    */

	public class mvnforummessagestatistics_service
	{
        public  mvnforummessagestatistics_core _dal=classFactory.getmvnforummessagestatistics();
		...
		public int insert_mvnforummessagestatistics (mvnforummessagestatistics_Dao _MVNFORUMMESSAGESTATISTICSModel )  throws Exception{
         return _dal.insert_mvnforummessagestatistics( _MVNFORUMMESSAGESTATISTICSModel);
		}
        ...
        return _dal.insert_mvnforummessagestatistics( _para);
        }
        ...
        return _dal.update_mvnforummessagestatistics( _MVNFORUMMESSAGESTATISTICSModel);
		}
        ...
        return _dal.delete_mvnforummessagestatistics( Fromid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_mvnforummessagestatisticsDao( Fromid);
		}
        ...
        * @throws Exception 
		...
		public List<mvnforummessagestatistics_Dao> get_mvnforummessagestatistics_All() throws Exception{
            return _dal.get_mvnforummessagestatistics_All();
            }
		    /**
         * 根据MVNFORUMMESSAGESTATISTICS返回的查询DataRow创建一个MVNFORUMMESSAGESTATISTICSEntity对象
         * @param MVNFORUMMESSAGESTATISTICS row
        ...
        * @throws Exception 
		...
		public List<mvnforummessagestatistics_Dao> get_mvnforummessagestatistics_All(String strWhere) throws Exception{
            return _dal.get_mvnforummessagestatistics_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<mvnforummessagestatistics_Dao> get_mvnforummessagestatistics_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_mvnforummessagestatistics_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据MVNFORUMMESSAGESTATISTICS返回的查询DataRow创建一个MVNFORUMMESSAGESTATISTICSEntity对象
         * @param MVNFORUMMESSAGESTATISTICS row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, mvnforummessagestatistics_Dao> get_mvnforummessagestatistics_Dictionary(String strWhere) throws Exception{
            return _dal.get_mvnforummessagestatistics_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_mvnforummessagestatistics_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_mvnforummessagestatistics_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_mvnforummessagestatistics_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_mvnforummessagestatistics_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createmvnforummessagestatistics_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_mvnforummessagestatistics_UpdateString( FieldName, Value, sid);
            }

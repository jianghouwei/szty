...
import java.util.List;
    ...
    */
	...
	public interface aihao34_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao34(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao34_Dao get_aihao34Dao(int _id) throws Exception;

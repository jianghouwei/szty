...
import java.util.List;
    ...
    */
	...
	public class clientupdate_service
	{
        public  clientupdate_core _dal=classFactory.getclientupdate();
		...
		public int insert_clientupdate (clientupdate_Dao _CLIENTUPDATEModel )  throws Exception{
         return _dal.insert_clientupdate( _CLIENTUPDATEModel);
		}
        ...
        return _dal.insert_clientupdate( _para);
        }
        ...
        return _dal.update_clientupdate( _CLIENTUPDATEModel);
		}
        ...
        return _dal.delete_clientupdate( Updateid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_clientupdateDao( Updateid);
		}
        ...
        * @throws Exception 
		...
		public List<clientupdate_Dao> get_clientupdate_All() throws Exception{
            return _dal.get_clientupdate_All();
            }
		    /**
         * 根据CLIENTUPDATE返回的查询DataRow创建一个CLIENTUPDATEEntity对象
         * @param CLIENTUPDATE row
        ...
        * @throws Exception 
		...
		public List<clientupdate_Dao> get_clientupdate_All(String strWhere) throws Exception{
            return _dal.get_clientupdate_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<clientupdate_Dao> get_clientupdate_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_clientupdate_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据CLIENTUPDATE返回的查询DataRow创建一个CLIENTUPDATEEntity对象
         * @param CLIENTUPDATE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, clientupdate_Dao> get_clientupdate_Dictionary(String strWhere) throws Exception{
            return _dal.get_clientupdate_Dictionary(strWhere);
            }
		 /**
         * 更新CLIENTUPDATE字段加一
         * @param FieldName
	    ...
	    public int create_clientupdate_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_clientupdate_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_clientupdate_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_clientupdate_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createclientupdate_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_clientupdate_UpdateString( FieldName, Value, sid);
            }

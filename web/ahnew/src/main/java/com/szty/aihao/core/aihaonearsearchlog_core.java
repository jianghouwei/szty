...
import java.util.List;
    ...
    */
	...
	public interface aihaonearsearchlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaonearsearchlog(int _logid) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaonearsearchlog_Dao get_aihaonearsearchlogDao(int _logid) throws Exception;

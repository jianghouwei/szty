...
import java.util.List;
    ...
    */
	...
	public class mobiletype_service
	{
        public  mobiletype_core _dal=classFactory.getmobiletype();
		...
		public int insert_mobiletype (mobiletype_Dao _MOBILETYPEModel )  throws Exception{
         return _dal.insert_mobiletype( _MOBILETYPEModel);
		}
        ...
        return _dal.insert_mobiletype( _para);
        }
        ...
        return _dal.update_mobiletype( _MOBILETYPEModel);
		}
        ...
        return _dal.delete_mobiletype( Motypeid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_mobiletypeDao( Motypeid);
		}
        ...
        * @throws Exception 
		...
		public List<mobiletype_Dao> get_mobiletype_All() throws Exception{
            return _dal.get_mobiletype_All();
            }
		    /**
         * 根据MOBILETYPE返回的查询DataRow创建一个MOBILETYPEEntity对象
         * @param MOBILETYPE row
        ...
        * @throws Exception 
		...
		public List<mobiletype_Dao> get_mobiletype_All(String strWhere) throws Exception{
            return _dal.get_mobiletype_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<mobiletype_Dao> get_mobiletype_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_mobiletype_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据MOBILETYPE返回的查询DataRow创建一个MOBILETYPEEntity对象
         * @param MOBILETYPE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, mobiletype_Dao> get_mobiletype_Dictionary(String strWhere) throws Exception{
            return _dal.get_mobiletype_Dictionary(strWhere);
            }
		 /**
         * 更新MOBILETYPE字段加一
         * @param FieldName
	    ...
	    public int create_mobiletype_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_mobiletype_UpdateIncreate( FieldName, sid);
            }
         /**
         * 更新MOBILETYPEInt型字段
         * @param FieldName
	    ...
	    public int create_mobiletype_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_mobiletype_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createmobiletype_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_mobiletype_UpdateString( FieldName, Value, sid);
            }

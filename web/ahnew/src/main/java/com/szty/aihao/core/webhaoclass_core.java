...
import java.util.List;
    ...
    */
	...
	public interface webhaoclass_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_webhaoclass(int _cat) throws Exception;
        ...
        * @throws Exception 
         */
		public webhaoclass_Dao get_webhaoclassDao(int _cat) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness26_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness26(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness26_Dao get_aihaobusiness26Dao(int _sname) throws Exception;

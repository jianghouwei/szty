...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp13_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp13(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp13_Dao get_aihaoiptmp13Dao(int _id) throws Exception;

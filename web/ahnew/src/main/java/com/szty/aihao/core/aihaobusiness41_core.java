...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness41_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness41(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness41_Dao get_aihaobusiness41Dao(int _sname) throws Exception;

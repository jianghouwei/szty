...
import java.util.List;
    ...
    */
	...
	public interface expruletable_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_expruletable(int _ruleid) throws Exception;
        ...
        * @throws Exception 
         */
		public expruletable_Dao get_expruletableDao(int _ruleid) throws Exception;

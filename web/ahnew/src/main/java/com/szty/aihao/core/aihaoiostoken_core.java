...
import java.util.List;
    ...
    */
	...
	public interface aihaoiostoken_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiostoken(int _productid) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiostoken_Dao get_aihaoiostokenDao(int _productid) throws Exception;

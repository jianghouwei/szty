...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp17_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp17(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp17_Dao get_aihaoiptmp17Dao(int _id) throws Exception;

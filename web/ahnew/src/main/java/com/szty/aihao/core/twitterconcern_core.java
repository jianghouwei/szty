...
import java.util.List;
    ...
    */
	...
	public interface twitterconcern_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_twitterconcern(int _concernid) throws Exception;
        ...
        * @throws Exception 
         */
		public twitterconcern_Dao get_twitterconcernDao(int _concernid) throws Exception;

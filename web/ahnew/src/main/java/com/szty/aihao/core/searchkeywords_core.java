...
import java.util.List;
    ...
    */
	...
	public interface searchkeywords_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_searchkeywords(int _searchkeyid) throws Exception;
        ...
        * @throws Exception 
         */
		public searchkeywords_Dao get_searchkeywordsDao(int _searchkeyid) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp27_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp27(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp27_Dao get_aihaoiptmp27Dao(int _id) throws Exception;

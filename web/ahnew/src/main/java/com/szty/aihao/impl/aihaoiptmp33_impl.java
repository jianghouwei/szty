...
*@作者：宋春林 
*/
public class aihaoiptmp33_impl implements aihaoiptmp33_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp33_impl.class);
...
public int insert_aihaoiptmp33(aihaoiptmp33_Dao _AIHAOIPTMP33Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP33_PRO.InsertAIHAOIPTMP33(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP33Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP33Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP33Model.getY());
...
public int update_aihaoiptmp33(aihaoiptmp33_Dao _AIHAOIPTMP33Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP33_PRO.UpdateAIHAOIPTMP33(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP33Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP33Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP33Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp33(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP33_PRO.DeleteAIHAOIPTMP33(?)}";
...
public aihaoiptmp33_Dao get_aihaoiptmp33Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP33_PRO.GetAIHAOIPTMP33Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp33_Dao _obj = new aihaoiptmp33_Dao();
...
public List<aihaoiptmp33_Dao> get_aihaoiptmp33_All() throws Exception{
        List<aihaoiptmp33_Dao> _list = new ArrayList<aihaoiptmp33_Dao>();
		String sqlStr = "{ call AIHAOIPTMP33_PRO.GetAIHAOIPTMP33(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp33_Dao> get_aihaoiptmp33_All(String strWhere) throws Exception{
         List<aihaoiptmp33_Dao> _list = new ArrayList<aihaoiptmp33_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP33_PRO.GetAIHAOIPTMP33Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp33_Dao> get_aihaoiptmp33_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp33_Dao> _list = new ArrayList<aihaoiptmp33_Dao>();
		String sqlStr = "{ call AIHAOIPTMP33_PRO.GetAIHAOIPTMP33Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp33_Dao> get_aihaoiptmp33_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp33strWhere") == null) {
			Dictionary<Integer, aihaoiptmp33_Dao> _dic = new Hashtable<Integer, aihaoiptmp33_Dao>();
			List<aihaoiptmp33_Dao> _list = new ArrayList<aihaoiptmp33_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp33", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp33_Dao> _dic = (Dictionary<Integer, aihaoiptmp33_Dao>) classFactory
					.cacheGet("dicaihaoiptmp33strWhere");
...
public int create_aihaoiptmp33_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP33_PRO.UpdateFieldAIHAOIPTMP33(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP33_PRO.UpdateFieldAIHAOIPTMP33V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP33_PRO.UpdateFieldAIHAOIPTMP33U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

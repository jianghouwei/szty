...
import java.util.List;
    ...
    */
	...
	public interface userrequest_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_userrequest(int _msgid) throws Exception;
        ...
        * @throws Exception 
         */
		public userrequest_Dao get_userrequestDao(int _msgid) throws Exception;

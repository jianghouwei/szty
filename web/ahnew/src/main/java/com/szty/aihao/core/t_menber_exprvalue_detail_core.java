...
import java.util.List;
    ...
    */
	...
	public interface t_menber_exprvalue_detail_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_t_menber_exprvalue_detail(int _uniquevalue) throws Exception;
        ...
        * @throws Exception 
         */
		public t_menber_exprvalue_detail_Dao get_t_menber_exprvalue_detailDao(int _uniquevalue) throws Exception;

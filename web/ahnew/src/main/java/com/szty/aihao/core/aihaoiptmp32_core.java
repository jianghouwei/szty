...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp32_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp32(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp32_Dao get_aihaoiptmp32Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    /**
    *@文件说明
    *@MVNFORUMFAVORITETHREAD逻辑层接口
    *@作者：宋春林 
    */

	public class mvnforumfavoritethread_service
	{
        public  mvnforumfavoritethread_core _dal=classFactory.getmvnforumfavoritethread();
		...
		public int insert_mvnforumfavoritethread (mvnforumfavoritethread_Dao _MVNFORUMFAVORITETHREADModel )  throws Exception{
         return _dal.insert_mvnforumfavoritethread( _MVNFORUMFAVORITETHREADModel);
		}
        ...
        return _dal.insert_mvnforumfavoritethread( _para);
        }
        ...
        return _dal.update_mvnforumfavoritethread( _MVNFORUMFAVORITETHREADModel);
		}
        ...
        return _dal.delete_mvnforumfavoritethread( Memberid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_mvnforumfavoritethreadDao( Memberid);
		}
        ...
        * @throws Exception 
		...
		public List<mvnforumfavoritethread_Dao> get_mvnforumfavoritethread_All() throws Exception{
            return _dal.get_mvnforumfavoritethread_All();
            }
		    /**
         * 根据MVNFORUMFAVORITETHREAD返回的查询DataRow创建一个MVNFORUMFAVORITETHREADEntity对象
         * @param MVNFORUMFAVORITETHREAD row
        ...
        * @throws Exception 
		...
		public List<mvnforumfavoritethread_Dao> get_mvnforumfavoritethread_All(String strWhere) throws Exception{
            return _dal.get_mvnforumfavoritethread_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<mvnforumfavoritethread_Dao> get_mvnforumfavoritethread_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_mvnforumfavoritethread_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据MVNFORUMFAVORITETHREAD返回的查询DataRow创建一个MVNFORUMFAVORITETHREADEntity对象
         * @param MVNFORUMFAVORITETHREAD row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, mvnforumfavoritethread_Dao> get_mvnforumfavoritethread_Dictionary(String strWhere) throws Exception{
            return _dal.get_mvnforumfavoritethread_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_mvnforumfavoritethread_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_mvnforumfavoritethread_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_mvnforumfavoritethread_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_mvnforumfavoritethread_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createmvnforumfavoritethread_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_mvnforumfavoritethread_UpdateString( FieldName, Value, sid);
            }

...
*@文件： dataTmp_dz_1101_jh_ggg.java
*@项目名称：JAVA项目管理 
*@创建时间：2015/10/15
*@===================================================================
*/
...
*@作者：宋春林 
*/
public class tmp_dz_1101_jh_ggg_impl implements tmp_dz_1101_jh_ggg_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(tmp_dz_1101_jh_ggg_impl.class);
...
public int insert_tmp_dz_1101_jh_ggg(tmp_dz_1101_jh_ggg_Dao _TMP_DZ_1101_JH_GGGModel)  throws Exception{
         String sqlStr = "{call TMP_DZ_1101_JH_GGG_PRO.InsertTMP_DZ_1101_JH_GGG(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_TMP_DZ_1101_JH_GGGModel.getP1());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP2());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP3());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP4());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP5());
...
public int update_tmp_dz_1101_jh_ggg(tmp_dz_1101_jh_ggg_Dao _TMP_DZ_1101_JH_GGGModel)  throws Exception{
        String sqlStr = "{call TMP_DZ_1101_JH_GGG_PRO.UpdateTMP_DZ_1101_JH_GGG(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP1());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP2());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP3());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP4());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_1101_JH_GGGModel.getP5());
...
public int delete_tmp_dz_1101_jh_ggg(int P1)  throws Exception{
        String sqlStr = "{call TMP_DZ_1101_JH_GGG_PRO.DeleteTMP_DZ_1101_JH_GGG(?)}";
...
public tmp_dz_1101_jh_ggg_Dao get_tmp_dz_1101_jh_gggDao(int P1) throws Exception{
         String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.GetTMP_DZ_1101_JH_GGGEntity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, P1);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			tmp_dz_1101_jh_ggg_Dao _obj = new tmp_dz_1101_jh_ggg_Dao();
...
public List<tmp_dz_1101_jh_ggg_Dao> get_tmp_dz_1101_jh_ggg_All() throws Exception{
        List<tmp_dz_1101_jh_ggg_Dao> _list = new ArrayList<tmp_dz_1101_jh_ggg_Dao>();
		String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.GetTMP_DZ_1101_JH_GGG(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< tmp_dz_1101_jh_ggg_Dao> get_tmp_dz_1101_jh_ggg_All(String strWhere) throws Exception{
         List<tmp_dz_1101_jh_ggg_Dao> _list = new ArrayList<tmp_dz_1101_jh_ggg_Dao>();
		 String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.GetTMP_DZ_1101_JH_GGGWhere(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<tmp_dz_1101_jh_ggg_Dao> get_tmp_dz_1101_jh_ggg_Page(int pageSize, int pageIndex,
		...
		List<tmp_dz_1101_jh_ggg_Dao> _list = new ArrayList<tmp_dz_1101_jh_ggg_Dao>();
		String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.GetTMP_DZ_1101_JH_GGGPage(?,?,?,?,?,?)}";
...
public Dictionary<Integer, tmp_dz_1101_jh_ggg_Dao> get_tmp_dz_1101_jh_ggg_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dictmp_dz_1101_jh_gggstrWhere") == null) {
			Dictionary<Integer, tmp_dz_1101_jh_ggg_Dao> _dic = new Hashtable<Integer, tmp_dz_1101_jh_ggg_Dao>();
			List<tmp_dz_1101_jh_ggg_Dao> _list = new ArrayList<tmp_dz_1101_jh_ggg_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getP1()), _list.get(i));
			}
			classFactory.cachePut("dictmp_dz_1101_jh_ggg", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, tmp_dz_1101_jh_ggg_Dao> _dic = (Dictionary<Integer, tmp_dz_1101_jh_ggg_Dao>) classFactory
					.cacheGet("dictmp_dz_1101_jh_gggstrWhere");
...
public int create_tmp_dz_1101_jh_ggg_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.UpdateFieldTMP_DZ_1101_JH_GGG(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.UpdateFieldTMP_DZ_1101_JH_GGGV(?,?,?)}";
...
{
        String sqlStr = "{ call TMP_DZ_1101_JH_GGG_PRO.UpdateFieldTMP_DZ_1101_JH_GGGU(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

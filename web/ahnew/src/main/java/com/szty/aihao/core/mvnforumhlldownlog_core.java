...
import java.util.List;
    ...
    */
	...
	public interface mvnforumhlldownlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumhlldownlog(int _downloadid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumhlldownlog_Dao get_mvnforumhlldownlogDao(int _downloadid) throws Exception;

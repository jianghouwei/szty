...
*@作者：宋春林 
*/
public class aihaoiptmp16_impl implements aihaoiptmp16_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp16_impl.class);
...
public int insert_aihaoiptmp16(aihaoiptmp16_Dao _AIHAOIPTMP16Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP16_PRO.InsertAIHAOIPTMP16(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP16Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP16Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP16Model.getY());
...
public int update_aihaoiptmp16(aihaoiptmp16_Dao _AIHAOIPTMP16Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP16_PRO.UpdateAIHAOIPTMP16(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP16Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP16Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP16Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp16(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP16_PRO.DeleteAIHAOIPTMP16(?)}";
...
public aihaoiptmp16_Dao get_aihaoiptmp16Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP16_PRO.GetAIHAOIPTMP16Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp16_Dao _obj = new aihaoiptmp16_Dao();
...
public List<aihaoiptmp16_Dao> get_aihaoiptmp16_All() throws Exception{
        List<aihaoiptmp16_Dao> _list = new ArrayList<aihaoiptmp16_Dao>();
		String sqlStr = "{ call AIHAOIPTMP16_PRO.GetAIHAOIPTMP16(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp16_Dao> get_aihaoiptmp16_All(String strWhere) throws Exception{
         List<aihaoiptmp16_Dao> _list = new ArrayList<aihaoiptmp16_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP16_PRO.GetAIHAOIPTMP16Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp16_Dao> get_aihaoiptmp16_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp16_Dao> _list = new ArrayList<aihaoiptmp16_Dao>();
		String sqlStr = "{ call AIHAOIPTMP16_PRO.GetAIHAOIPTMP16Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp16_Dao> get_aihaoiptmp16_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp16strWhere") == null) {
			Dictionary<Integer, aihaoiptmp16_Dao> _dic = new Hashtable<Integer, aihaoiptmp16_Dao>();
			List<aihaoiptmp16_Dao> _list = new ArrayList<aihaoiptmp16_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp16", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp16_Dao> _dic = (Dictionary<Integer, aihaoiptmp16_Dao>) classFactory
					.cacheGet("dicaihaoiptmp16strWhere");
...
public int create_aihaoiptmp16_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP16_PRO.UpdateFieldAIHAOIPTMP16(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP16_PRO.UpdateFieldAIHAOIPTMP16V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP16_PRO.UpdateFieldAIHAOIPTMP16U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

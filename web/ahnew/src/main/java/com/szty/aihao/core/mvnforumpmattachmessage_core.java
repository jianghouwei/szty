...
import java.util.List;
    ...
    */
	...
	public interface mvnforumpmattachmessage_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumpmattachmessage(int _messageid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumpmattachmessage_Dao get_mvnforumpmattachmessageDao(int _messageid) throws Exception;

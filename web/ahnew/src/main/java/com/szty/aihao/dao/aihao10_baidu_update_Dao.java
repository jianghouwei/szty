 ...
 *@文件： aihao10_baidu_updateEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAO10_BAIDU_UPDATE数据实体
    *@作者：宋春林 
    */

	public class aihao10_baidu_update_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihao10_baidu_update_Dao _dao){
        aihao_dao temp=new aihao_dao();
        temp.setNextval(_dao.getNextval());

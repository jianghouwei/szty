...
import java.util.List;
    ...
    */
	...
	public interface mvnforummemberforum_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforummemberforum(int _memberid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforummemberforum_Dao get_mvnforummemberforumDao(int _memberid) throws Exception;

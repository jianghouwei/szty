...
import java.util.List;
    ...
    */
	...
	public interface mvnforumcategory_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumcategory(int _categoryid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumcategory_Dao get_mvnforumcategoryDao(int _categoryid) throws Exception;

...
*@作者：宋春林 
*/
public class aihaoiptmp10_impl implements aihaoiptmp10_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp10_impl.class);
...
public int insert_aihaoiptmp10(aihaoiptmp10_Dao _AIHAOIPTMP10Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP10_PRO.InsertAIHAOIPTMP10(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP10Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP10Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP10Model.getY());
...
public int update_aihaoiptmp10(aihaoiptmp10_Dao _AIHAOIPTMP10Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP10_PRO.UpdateAIHAOIPTMP10(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP10Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP10Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP10Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp10(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP10_PRO.DeleteAIHAOIPTMP10(?)}";
...
public aihaoiptmp10_Dao get_aihaoiptmp10Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP10_PRO.GetAIHAOIPTMP10Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp10_Dao _obj = new aihaoiptmp10_Dao();
...
public List<aihaoiptmp10_Dao> get_aihaoiptmp10_All() throws Exception{
        List<aihaoiptmp10_Dao> _list = new ArrayList<aihaoiptmp10_Dao>();
		String sqlStr = "{ call AIHAOIPTMP10_PRO.GetAIHAOIPTMP10(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp10_Dao> get_aihaoiptmp10_All(String strWhere) throws Exception{
         List<aihaoiptmp10_Dao> _list = new ArrayList<aihaoiptmp10_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP10_PRO.GetAIHAOIPTMP10Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp10_Dao> get_aihaoiptmp10_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp10_Dao> _list = new ArrayList<aihaoiptmp10_Dao>();
		String sqlStr = "{ call AIHAOIPTMP10_PRO.GetAIHAOIPTMP10Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp10_Dao> get_aihaoiptmp10_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp10strWhere") == null) {
			Dictionary<Integer, aihaoiptmp10_Dao> _dic = new Hashtable<Integer, aihaoiptmp10_Dao>();
			List<aihaoiptmp10_Dao> _list = new ArrayList<aihaoiptmp10_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp10", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp10_Dao> _dic = (Dictionary<Integer, aihaoiptmp10_Dao>) classFactory
					.cacheGet("dicaihaoiptmp10strWhere");
...
public int create_aihaoiptmp10_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP10_PRO.UpdateFieldAIHAOIPTMP10(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP10_PRO.UpdateFieldAIHAOIPTMP10V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP10_PRO.UpdateFieldAIHAOIPTMP10U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

...
import java.util.List;
    ...
    */
	...
	public interface aihao20_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao20(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao20_Dao get_aihao20Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihao_number_bak_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao_number_bak(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao_number_bak_Dao get_aihao_number_bakDao(int _id) throws Exception;

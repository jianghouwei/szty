...
*@作者：宋春林 
*/
public class tmp_dz_120824_zc_impl implements tmp_dz_120824_zc_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(tmp_dz_120824_zc_impl.class);
...
public int insert_tmp_dz_120824_zc(tmp_dz_120824_zc_Dao _TMP_DZ_120824_ZCModel)  throws Exception{
         String sqlStr = "{call TMP_DZ_120824_ZC_PRO.InsertTMP_DZ_120824_ZC(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_TMP_DZ_120824_ZCModel.getP1());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP2());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP3());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP4());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP5());
...
public int update_tmp_dz_120824_zc(tmp_dz_120824_zc_Dao _TMP_DZ_120824_ZCModel)  throws Exception{
        String sqlStr = "{call TMP_DZ_120824_ZC_PRO.UpdateTMP_DZ_120824_ZC(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP1());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP2());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP3());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP4());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TMP_DZ_120824_ZCModel.getP5());
...
public int delete_tmp_dz_120824_zc(int P1)  throws Exception{
        String sqlStr = "{call TMP_DZ_120824_ZC_PRO.DeleteTMP_DZ_120824_ZC(?)}";
...
public tmp_dz_120824_zc_Dao get_tmp_dz_120824_zcDao(int P1) throws Exception{
         String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.GetTMP_DZ_120824_ZCEntity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, P1);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			tmp_dz_120824_zc_Dao _obj = new tmp_dz_120824_zc_Dao();
...
public List<tmp_dz_120824_zc_Dao> get_tmp_dz_120824_zc_All() throws Exception{
        List<tmp_dz_120824_zc_Dao> _list = new ArrayList<tmp_dz_120824_zc_Dao>();
		String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.GetTMP_DZ_120824_ZC(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< tmp_dz_120824_zc_Dao> get_tmp_dz_120824_zc_All(String strWhere) throws Exception{
         List<tmp_dz_120824_zc_Dao> _list = new ArrayList<tmp_dz_120824_zc_Dao>();
		 String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.GetTMP_DZ_120824_ZCWhere(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<tmp_dz_120824_zc_Dao> get_tmp_dz_120824_zc_Page(int pageSize, int pageIndex,
		...
		List<tmp_dz_120824_zc_Dao> _list = new ArrayList<tmp_dz_120824_zc_Dao>();
		String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.GetTMP_DZ_120824_ZCPage(?,?,?,?,?,?)}";
...
public Dictionary<Integer, tmp_dz_120824_zc_Dao> get_tmp_dz_120824_zc_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dictmp_dz_120824_zcstrWhere") == null) {
			Dictionary<Integer, tmp_dz_120824_zc_Dao> _dic = new Hashtable<Integer, tmp_dz_120824_zc_Dao>();
			List<tmp_dz_120824_zc_Dao> _list = new ArrayList<tmp_dz_120824_zc_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getP1()), _list.get(i));
			}
			classFactory.cachePut("dictmp_dz_120824_zc", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, tmp_dz_120824_zc_Dao> _dic = (Dictionary<Integer, tmp_dz_120824_zc_Dao>) classFactory
					.cacheGet("dictmp_dz_120824_zcstrWhere");
...
public int create_tmp_dz_120824_zc_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.UpdateFieldTMP_DZ_120824_ZC(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.UpdateFieldTMP_DZ_120824_ZCV(?,?,?)}";
...
{
        String sqlStr = "{ call TMP_DZ_120824_ZC_PRO.UpdateFieldTMP_DZ_120824_ZCU(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

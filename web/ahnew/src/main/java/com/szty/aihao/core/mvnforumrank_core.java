...
import java.util.List;
    ...
    */
	...
	public interface mvnforumrank_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumrank(int _rankid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumrank_Dao get_mvnforumrankDao(int _rankid) throws Exception;

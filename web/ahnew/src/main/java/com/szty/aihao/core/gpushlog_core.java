...
import java.util.List;
    ...
    */
	...
	public interface gpushlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_gpushlog(int _gpuahlogid) throws Exception;
        ...
        * @throws Exception 
         */
		public gpushlog_Dao get_gpushlogDao(int _gpuahlogid) throws Exception;

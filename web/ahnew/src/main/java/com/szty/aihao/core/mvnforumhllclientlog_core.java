...
import java.util.List;
    ...
    */
	...
	public interface mvnforumhllclientlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumhllclientlog(int _logid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumhllclientlog_Dao get_mvnforumhllclientlogDao(int _logid) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaosearchlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaosearchlog(int _logid) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaosearchlog_Dao get_aihaosearchlogDao(int _logid) throws Exception;

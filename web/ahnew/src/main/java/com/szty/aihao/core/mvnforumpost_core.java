...
import java.util.List;
    ...
    */
	...
	public interface mvnforumpost_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumpost(int _postid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumpost_Dao get_mvnforumpostDao(int _postid) throws Exception;

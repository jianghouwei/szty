...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness20_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness20(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness20_Dao get_aihaobusiness20Dao(int _sname) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public class osmobile_service
	{
        public  osmobile_core _dal=classFactory.getosmobile();
		...
		public int insert_osmobile (osmobile_Dao _OSMOBILEModel )  throws Exception{
         return _dal.insert_osmobile( _OSMOBILEModel);
		}
        ...
        return _dal.insert_osmobile( _para);
        }
        ...
        return _dal.update_osmobile( _OSMOBILEModel);
		}
        ...
        return _dal.delete_osmobile( Osid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_osmobileDao( Osid);
		}
        ...
        * @throws Exception 
		...
		public List<osmobile_Dao> get_osmobile_All(String strWhere) throws Exception{
            return _dal.get_osmobile_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<osmobile_Dao> get_osmobile_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_osmobile_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据OSMOBILE返回的查询DataRow创建一个OSMOBILEEntity对象
         * @param OSMOBILE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, osmobile_Dao> get_osmobile_Dictionary(String strWhere) throws Exception{
            return _dal.get_osmobile_Dictionary(strWhere);
            }
		 /**
         * 更新OSMOBILE字段加一
         * @param FieldName
	    ...
	    public int create_osmobile_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_osmobile_UpdateIncreate( FieldName, sid);
            }
         /**
         * 更新OSMOBILEInt型字段
         * @param FieldName
	    ...
	    public int create_osmobile_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_osmobile_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createosmobile_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_osmobile_UpdateString( FieldName, Value, sid);
            }

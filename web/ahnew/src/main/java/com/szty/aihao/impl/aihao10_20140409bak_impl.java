...
*@文件： dataAihao10_20140409bak.java
*@项目名称：JAVA项目管理 
*@创建时间：2015/10/15
*@===================================================================
*/
...
*@作者：宋春林 
*/
public class aihao10_20140409bak_impl implements aihao10_20140409bak_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihao10_20140409bak_impl.class);
...
public int insert_aihao10_20140409bak(aihao10_20140409bak_Dao _AIHAO10_20140409BAKModel)  throws Exception{
         String sqlStr = "{call AIHAO10_20140409BAK_PRO.InsertAIHAO10_20140409BAK(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[52];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAO10_20140409BAKModel.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getName());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getTelno());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getAddress());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBranch_name());
        op[5]= new OracleParameter(6, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getShort_name());
        op[6]= new OracleParameter(7, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getIntroduction());
        op[7]= new OracleParameter(8, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getRecommendation());
        op[8]= new OracleParameter(9, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getFeature());
        op[9]= new OracleParameter(10, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getSpecial_offer());
        op[10]= new OracleParameter(11, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getStyle());
        op[11]= new OracleParameter(12, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getProvince_id());
        op[12]= new OracleParameter(13, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getCity_id());
        op[13]= new OracleParameter(14, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getDistrict_id());
        op[14]= new OracleParameter(15, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getTrade_id());
        op[15]= new OracleParameter(16, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getProvince_name());
        op[16]= new OracleParameter(17, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getCity_name());
        op[17]= new OracleParameter(18, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getDistrict_name());
        op[18]= new OracleParameter(19, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getTrade_name());
        op[19]= new OracleParameter(20, "IN", java.sql.Types.DATE, dateformat.format(_AIHAO10_20140409BAKModel.getCreated_at()));
        op[20]= new OracleParameter(21, "IN", java.sql.Types.DATE, dateformat.format(_AIHAO10_20140409BAKModel.getUpdated_at()));
        op[21]= new OracleParameter(22, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getService_mask());
        op[22]= new OracleParameter(23, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getX());
        op[23]= new OracleParameter(24, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getY());
        op[24]= new OracleParameter(25, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getLandmark());
        op[25]= new OracleParameter(26, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getRegion());
        op[26]= new OracleParameter(27, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getSource());
        op[27]= new OracleParameter(28, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getXy_level());
        op[28]= new OracleParameter(29, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getWeight());
        op[29]= new OracleParameter(30, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getIs_exist());
        op[30]= new OracleParameter(31, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getTag());
        op[31]= new OracleParameter(32, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getCategory());
        op[32]= new OracleParameter(33, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getPrice());
        op[33]= new OracleParameter(34, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getOpen_time());
        op[34]= new OracleParameter(35, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getOfficial_site());
        op[35]= new OracleParameter(36, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getWl_discount());
        op[36]= new OracleParameter(37, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBizcode());
        op[37]= new OracleParameter(38, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getStatus());
        op[38]= new OracleParameter(39, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getOwner());
        op[39]= new OracleParameter(40, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getCollector_id());
        op[40]= new OracleParameter(41, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getReview_count());
        op[41]= new OracleParameter(42, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getIs_disp());
        op[42]= new OracleParameter(43, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getAttributes());
        op[43]= new OracleParameter(44, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getLevelv());
        op[44]= new OracleParameter(45, "IN", java.sql.Types.NUMERIC,_AIHAO10_20140409BAKModel.getRow_num());
        op[45]= new OracleParameter(46, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getGeohas());
        op[46]= new OracleParameter(47, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBaidux());
        op[47]= new OracleParameter(48, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBaiduy());
        op[48]= new OracleParameter(49, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBigclass());
        op[49]= new OracleParameter(50, "IN", java.sql.Types.NUMERIC,_AIHAO10_20140409BAKModel.getYouxiannum());
        op[50]= new OracleParameter(51, "IN", java.sql.Types.NUMERIC,_AIHAO10_20140409BAKModel.getShowstatus());
        op[51]= new OracleParameter(52, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getDdyhbandid());
...
public int update_aihao10_20140409bak(aihao10_20140409bak_Dao _AIHAO10_20140409BAKModel)  throws Exception{
        String sqlStr = "{call AIHAO10_20140409BAK_PRO.UpdateAIHAO10_20140409BAK(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[52];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getName());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getTelno());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getAddress());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_AIHAO10_20140409BAKModel.getBranch_name());
...
public int delete_aihao10_20140409bak(int Id)  throws Exception{
        String sqlStr = "{call AIHAO10_20140409BAK_PRO.DeleteAIHAO10_20140409BAK(?)}";
...
public aihao10_20140409bak_Dao get_aihao10_20140409bakDao(int Id) throws Exception{
         String sqlStr = "{ call AIHAO10_20140409BAK_PRO.GetAIHAO10_20140409BAKEntity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihao10_20140409bak_Dao _obj = new aihao10_20140409bak_Dao();
...
public List<aihao10_20140409bak_Dao> get_aihao10_20140409bak_All() throws Exception{
        List<aihao10_20140409bak_Dao> _list = new ArrayList<aihao10_20140409bak_Dao>();
		String sqlStr = "{ call AIHAO10_20140409BAK_PRO.GetAIHAO10_20140409BAK(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihao10_20140409bak_Dao> get_aihao10_20140409bak_All(String strWhere) throws Exception{
         List<aihao10_20140409bak_Dao> _list = new ArrayList<aihao10_20140409bak_Dao>();
		 String sqlStr = "{ call AIHAO10_20140409BAK_PRO.GetAIHAO10_20140409BAKWhere(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihao10_20140409bak_Dao> get_aihao10_20140409bak_Page(int pageSize, int pageIndex,
		...
		List<aihao10_20140409bak_Dao> _list = new ArrayList<aihao10_20140409bak_Dao>();
		String sqlStr = "{ call AIHAO10_20140409BAK_PRO.GetAIHAO10_20140409BAKPage(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihao10_20140409bak_Dao> get_aihao10_20140409bak_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihao10_20140409bakstrWhere") == null) {
			Dictionary<Integer, aihao10_20140409bak_Dao> _dic = new Hashtable<Integer, aihao10_20140409bak_Dao>();
			List<aihao10_20140409bak_Dao> _list = new ArrayList<aihao10_20140409bak_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihao10_20140409bak", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihao10_20140409bak_Dao> _dic = (Dictionary<Integer, aihao10_20140409bak_Dao>) classFactory
					.cacheGet("dicaihao10_20140409bakstrWhere");
...
public int create_aihao10_20140409bak_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAO10_20140409BAK_PRO.UpdateFieldAIHAO10_20140409BAK(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAO10_20140409BAK_PRO.UpdateFieldAIHAO10_20140409BAKV(?,?,?)}";
...
{
        String sqlStr = "{ call AIHAO10_20140409BAK_PRO.UpdateFieldAIHAO10_20140409BAKU(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

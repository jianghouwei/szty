...
import java.util.List;
    ...
    */
	...
	public interface mvnforummessage_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforummessage(int _messageid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforummessage_Dao get_mvnforummessageDao(int _messageid) throws Exception;

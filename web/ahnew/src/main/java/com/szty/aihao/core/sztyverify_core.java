...
import java.util.List;
    ...
    */
	...
	public interface sztyverify_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_sztyverify(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public sztyverify_Dao get_sztyverifyDao(int _id) throws Exception;

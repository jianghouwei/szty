 ...
 *@文件： aihao_tj_parset_bakEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAO_TJ_PARSET_BAK数据实体
    *@作者：宋春林 
    */

	public class aihao_tj_parset_bak_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihao_tj_parset_bak_Dao _dao){

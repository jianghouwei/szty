...
import java.util.List;
    ...
    /**
    *@文件说明
    *@MVNFORUMMOBILEOS逻辑层接口
    *@作者：宋春林 
    */

	public class mvnforummobileos_service
	{
        public  mvnforummobileos_core _dal=classFactory.getmvnforummobileos();
		...
		public int insert_mvnforummobileos (mvnforummobileos_Dao _MVNFORUMMOBILEOSModel )  throws Exception{
         return _dal.insert_mvnforummobileos( _MVNFORUMMOBILEOSModel);
		}
        ...
        return _dal.insert_mvnforummobileos( _para);
        }
        ...
        return _dal.update_mvnforummobileos( _MVNFORUMMOBILEOSModel);
		}
        ...
        return _dal.delete_mvnforummobileos( Mobileosid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_mvnforummobileosDao( Mobileosid);
		}
        ...
        * @throws Exception 
		...
		public List<mvnforummobileos_Dao> get_mvnforummobileos_All() throws Exception{
            return _dal.get_mvnforummobileos_All();
            }
		    /**
         * 根据MVNFORUMMOBILEOS返回的查询DataRow创建一个MVNFORUMMOBILEOSEntity对象
         * @param MVNFORUMMOBILEOS row
        ...
        * @throws Exception 
		...
		public List<mvnforummobileos_Dao> get_mvnforummobileos_All(String strWhere) throws Exception{
            return _dal.get_mvnforummobileos_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<mvnforummobileos_Dao> get_mvnforummobileos_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_mvnforummobileos_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据MVNFORUMMOBILEOS返回的查询DataRow创建一个MVNFORUMMOBILEOSEntity对象
         * @param MVNFORUMMOBILEOS row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, mvnforummobileos_Dao> get_mvnforummobileos_Dictionary(String strWhere) throws Exception{
            return _dal.get_mvnforummobileos_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_mvnforummobileos_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_mvnforummobileos_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_mvnforummobileos_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_mvnforummobileos_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createmvnforummobileos_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_mvnforummobileos_UpdateString( FieldName, Value, sid);
            }

...
import java.util.List;
    ...
    */
	...
	public interface twitterphoto_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_twitterphoto(int _photoid) throws Exception;
        ...
        * @throws Exception 
         */
		public twitterphoto_Dao get_twitterphotoDao(int _photoid) throws Exception;

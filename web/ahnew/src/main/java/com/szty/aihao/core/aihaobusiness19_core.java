...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness19_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness19(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness19_Dao get_aihaobusiness19Dao(int _sname) throws Exception;

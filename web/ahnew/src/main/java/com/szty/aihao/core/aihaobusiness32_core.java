...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness32_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness32(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness32_Dao get_aihaobusiness32Dao(int _sname) throws Exception;

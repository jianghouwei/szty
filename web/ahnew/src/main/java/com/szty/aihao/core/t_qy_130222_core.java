...
import java.util.List;
    ...
    */
	...
	public interface t_qy_130222_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_t_qy_130222(int _pcontent) throws Exception;
        ...
        * @throws Exception 
         */
		public t_qy_130222_Dao get_t_qy_130222Dao(int _pcontent) throws Exception;

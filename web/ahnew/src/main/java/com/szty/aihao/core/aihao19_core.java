...
import java.util.List;
    ...
    */
	...
	public interface aihao19_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao19(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao19_Dao get_aihao19Dao(int _id) throws Exception;

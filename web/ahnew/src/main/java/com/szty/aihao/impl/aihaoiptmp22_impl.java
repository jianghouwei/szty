...
*@作者：宋春林 
*/
public class aihaoiptmp22_impl implements aihaoiptmp22_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp22_impl.class);
...
public int insert_aihaoiptmp22(aihaoiptmp22_Dao _AIHAOIPTMP22Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP22_PRO.InsertAIHAOIPTMP22(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP22Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP22Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP22Model.getY());
...
public int update_aihaoiptmp22(aihaoiptmp22_Dao _AIHAOIPTMP22Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP22_PRO.UpdateAIHAOIPTMP22(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP22Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP22Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP22Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp22(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP22_PRO.DeleteAIHAOIPTMP22(?)}";
...
public aihaoiptmp22_Dao get_aihaoiptmp22Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP22_PRO.GetAIHAOIPTMP22Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp22_Dao _obj = new aihaoiptmp22_Dao();
...
public List<aihaoiptmp22_Dao> get_aihaoiptmp22_All() throws Exception{
        List<aihaoiptmp22_Dao> _list = new ArrayList<aihaoiptmp22_Dao>();
		String sqlStr = "{ call AIHAOIPTMP22_PRO.GetAIHAOIPTMP22(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp22_Dao> get_aihaoiptmp22_All(String strWhere) throws Exception{
         List<aihaoiptmp22_Dao> _list = new ArrayList<aihaoiptmp22_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP22_PRO.GetAIHAOIPTMP22Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp22_Dao> get_aihaoiptmp22_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp22_Dao> _list = new ArrayList<aihaoiptmp22_Dao>();
		String sqlStr = "{ call AIHAOIPTMP22_PRO.GetAIHAOIPTMP22Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp22_Dao> get_aihaoiptmp22_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp22strWhere") == null) {
			Dictionary<Integer, aihaoiptmp22_Dao> _dic = new Hashtable<Integer, aihaoiptmp22_Dao>();
			List<aihaoiptmp22_Dao> _list = new ArrayList<aihaoiptmp22_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp22", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp22_Dao> _dic = (Dictionary<Integer, aihaoiptmp22_Dao>) classFactory
					.cacheGet("dicaihaoiptmp22strWhere");
...
public int create_aihaoiptmp22_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP22_PRO.UpdateFieldAIHAOIPTMP22(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP22_PRO.UpdateFieldAIHAOIPTMP22V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP22_PRO.UpdateFieldAIHAOIPTMP22U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

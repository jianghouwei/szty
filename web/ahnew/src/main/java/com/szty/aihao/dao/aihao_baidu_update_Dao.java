 ...
 *@文件： aihao_baidu_updateEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAO_BAIDU_UPDATE数据实体
    *@作者：宋春林 
    */

	public class aihao_baidu_update_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihao_baidu_update_Dao _dao){

...
import java.util.List;
    ...
    */
	...
	public class aaace_service
	{
        public  aaace_core _dal=classFactory.getaaace();
		...
		public int insert_aaace (aaace_Dao _AAACEModel )  throws Exception{
         return _dal.insert_aaace( _AAACEModel);
		}
        ...
        return _dal.insert_aaace( _para);
        }
        ...
        return _dal.update_aaace( _AAACEModel);
		}
        ...
        * @throws Exception 
		...
		public List<aaace_Dao> get_aaace_All(String strWhere) throws Exception{
            return _dal.get_aaace_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<aaace_Dao> get_aaace_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_aaace_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据AAACE返回的查询DataRow创建一个AAACEEntity对象
         * @param AAACE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, aaace_Dao> get_aaace_Dictionary(String strWhere) throws Exception{
            return _dal.get_aaace_Dictionary(strWhere);
            }
		 /**
         * 更新AAACE字段加一
         * @param FieldName
	    ...
	    public int create_aaace_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_aaace_UpdateIncreate( FieldName, sid);
            }
         /**
         * 更新AAACEInt型字段
         * @param FieldName
	    ...
	    public int create_aaace_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_aaace_UpdateInteger( FieldName, Num, sid);
            }
          /**
         * 更新AAACEIString型字段
         * @param FieldName
         ...
         * @param sid
         */
	    public int createaaace_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_aaace_UpdateString( FieldName, Value, sid);
            }

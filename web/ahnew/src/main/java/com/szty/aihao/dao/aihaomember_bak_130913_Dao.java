 ...
 *@文件： aihaomember_bak_130913Entity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAOMEMBER_BAK_130913数据实体
    *@作者：宋春林 
    */

	public class aihaomember_bak_130913_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihaomember_bak_130913_Dao _dao){

...
import java.util.List;
    ...
    */
	...
	public interface mvnforumbookjar_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumbookjar(int _jarid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumbookjar_Dao get_mvnforumbookjarDao(int _jarid) throws Exception;

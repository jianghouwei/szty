...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp37_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp37(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp37_Dao get_aihaoiptmp37Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface gamecentergame_20130327_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_gamecentergame_20130327(int _gameid) throws Exception;
        ...
        * @throws Exception 
         */
		public gamecentergame_20130327_Dao get_gamecentergame_20130327Dao(int _gameid) throws Exception;

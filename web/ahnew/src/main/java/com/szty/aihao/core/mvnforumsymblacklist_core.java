...
import java.util.List;
    ...
    /**
    *@文件说明
    *@MVNFORUMSYMBLACKLIST数据接口
    *@作者：宋春林 
    */

	public interface mvnforumsymblacklist_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumsymblacklist(int _mobile) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumsymblacklist_Dao get_mvnforumsymblacklistDao(int _mobile) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<mvnforumsymblacklist_Dao> get_mvnforumsymblacklist_Page(int pageSize, int pageIndex,
	...
	public int create_mvnforumsymblacklist_UpdateInteger(String FieldName,int Num,int sid) throws Exception;
         ...
         * @param sid
         */
	public int create_mvnforumsymblacklist_UpdateString(String FieldName,String Value,int sid) throws Exception;

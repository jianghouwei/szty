...
import java.util.List;
    ...
    */
	...
	public class aihaoiptmp19_service
	{
        public  aihaoiptmp19_core _dal=classFactory.getaihaoiptmp19();
		...
		public int insert_aihaoiptmp19 (aihaoiptmp19_Dao _AIHAOIPTMP19Model )  throws Exception{
         return _dal.insert_aihaoiptmp19( _AIHAOIPTMP19Model);
		}
        ...
        return _dal.insert_aihaoiptmp19( _para);
        }
        ...
        return _dal.update_aihaoiptmp19( _AIHAOIPTMP19Model);
		}
        ...
        return _dal.delete_aihaoiptmp19( Id);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_aihaoiptmp19Dao( Id);
		}
        ...
        * @throws Exception 
		...
		public List<aihaoiptmp19_Dao> get_aihaoiptmp19_All() throws Exception{
            return _dal.get_aihaoiptmp19_All();
            }
		    /**
         * 根据AIHAOIPTMP19返回的查询DataRow创建一个AIHAOIPTMP19Entity对象
         * @param AIHAOIPTMP19 row
        ...
        * @throws Exception 
		...
		public List<aihaoiptmp19_Dao> get_aihaoiptmp19_All(String strWhere) throws Exception{
            return _dal.get_aihaoiptmp19_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<aihaoiptmp19_Dao> get_aihaoiptmp19_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_aihaoiptmp19_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据AIHAOIPTMP19返回的查询DataRow创建一个AIHAOIPTMP19Entity对象
         * @param AIHAOIPTMP19 row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, aihaoiptmp19_Dao> get_aihaoiptmp19_Dictionary(String strWhere) throws Exception{
            return _dal.get_aihaoiptmp19_Dictionary(strWhere);
            }
		 /**
         * 更新AIHAOIPTMP19字段加一
         * @param FieldName
	    ...
	    public int create_aihaoiptmp19_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_aihaoiptmp19_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_aihaoiptmp19_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_aihaoiptmp19_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createaihaoiptmp19_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_aihaoiptmp19_UpdateString( FieldName, Value, sid);
            }

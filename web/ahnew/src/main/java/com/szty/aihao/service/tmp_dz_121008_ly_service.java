...
import java.util.List;
    ...
    /**
    *@文件说明
    *@TMP_DZ_121008_LY逻辑层接口
    *@作者：宋春林 
    */

	public class tmp_dz_121008_ly_service
	{
        public  tmp_dz_121008_ly_core _dal=classFactory.gettmp_dz_121008_ly();
		...
		public int insert_tmp_dz_121008_ly (tmp_dz_121008_ly_Dao _TMP_DZ_121008_LYModel )  throws Exception{
         return _dal.insert_tmp_dz_121008_ly( _TMP_DZ_121008_LYModel);
		}
        
        /**
         * 向数据库中插入一条新记录。
         * @param TMP_DZ_121008_LYprrameter
         * @return 新插入记录的编号
         */
         public int insert_tmp_dz_121008_ly(Object[] _para)  throws Exception{
        return _dal.insert_tmp_dz_121008_ly( _para);
        }
        ...
        return _dal.update_tmp_dz_121008_ly( _TMP_DZ_121008_LYModel);
		}
        ...
        return _dal.delete_tmp_dz_121008_ly( P1);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_tmp_dz_121008_lyDao( P1);
		}
        ...
        * @throws Exception 
		...
		public List<tmp_dz_121008_ly_Dao> get_tmp_dz_121008_ly_All() throws Exception{
            return _dal.get_tmp_dz_121008_ly_All();
            }
		    /**
         * 根据TMP_DZ_121008_LY返回的查询DataRow创建一个TMP_DZ_121008_LYEntity对象
         * @param TMP_DZ_121008_LY row
        ...
        * @throws Exception 
		...
		public List<tmp_dz_121008_ly_Dao> get_tmp_dz_121008_ly_All(String strWhere) throws Exception{
            return _dal.get_tmp_dz_121008_ly_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<tmp_dz_121008_ly_Dao> get_tmp_dz_121008_ly_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_tmp_dz_121008_ly_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据TMP_DZ_121008_LY返回的查询DataRow创建一个TMP_DZ_121008_LYEntity对象
         * @param TMP_DZ_121008_LY row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, tmp_dz_121008_ly_Dao> get_tmp_dz_121008_ly_Dictionary(String strWhere) throws Exception{
            return _dal.get_tmp_dz_121008_ly_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_tmp_dz_121008_ly_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_tmp_dz_121008_ly_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_tmp_dz_121008_ly_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_tmp_dz_121008_ly_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createtmp_dz_121008_ly_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_tmp_dz_121008_ly_UpdateString( FieldName, Value, sid);
            }

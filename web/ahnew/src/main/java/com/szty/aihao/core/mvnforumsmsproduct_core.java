...
import java.util.List;
    ...
    */
	...
	public interface mvnforumsmsproduct_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumsmsproduct(int _productid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumsmsproduct_Dao get_mvnforumsmsproductDao(int _productid) throws Exception;

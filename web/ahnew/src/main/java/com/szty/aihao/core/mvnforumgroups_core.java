...
import java.util.List;
    ...
    */
	...
	public interface mvnforumgroups_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumgroups(int _groupid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumgroups_Dao get_mvnforumgroupsDao(int _groupid) throws Exception;

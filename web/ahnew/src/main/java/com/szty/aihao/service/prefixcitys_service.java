...
import java.util.List;
    ...
    */
	...
	public class prefixcitys_service
	{
        public  prefixcitys_core _dal=classFactory.getprefixcitys();
		...
		public int insert_prefixcitys (prefixcitys_Dao _PREFIXCITYSModel )  throws Exception{
         return _dal.insert_prefixcitys( _PREFIXCITYSModel);
		}
        ...
        return _dal.insert_prefixcitys( _para);
        }
        ...
        return _dal.update_prefixcitys( _PREFIXCITYSModel);
		}
        ...
        return _dal.delete_prefixcitys( Prefix);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_prefixcitysDao( Prefix);
		}
        ...
        * @throws Exception 
		...
		public List<prefixcitys_Dao> get_prefixcitys_All() throws Exception{
            return _dal.get_prefixcitys_All();
            }
		    /**
         * 根据PREFIXCITYS返回的查询DataRow创建一个PREFIXCITYSEntity对象
         * @param PREFIXCITYS row
        ...
        * @throws Exception 
		...
		public List<prefixcitys_Dao> get_prefixcitys_All(String strWhere) throws Exception{
            return _dal.get_prefixcitys_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<prefixcitys_Dao> get_prefixcitys_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_prefixcitys_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据PREFIXCITYS返回的查询DataRow创建一个PREFIXCITYSEntity对象
         * @param PREFIXCITYS row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, prefixcitys_Dao> get_prefixcitys_Dictionary(String strWhere) throws Exception{
            return _dal.get_prefixcitys_Dictionary(strWhere);
            }
		 /**
         * 更新PREFIXCITYS字段加一
         * @param FieldName
	    ...
	    public int create_prefixcitys_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_prefixcitys_UpdateIncreate( FieldName, sid);
            }
         /**
         * 更新PREFIXCITYSInt型字段
         * @param FieldName
	    ...
	    public int create_prefixcitys_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_prefixcitys_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createprefixcitys_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_prefixcitys_UpdateString( FieldName, Value, sid);
            }

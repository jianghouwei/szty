...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness17_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness17(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness17_Dao get_aihaobusiness17Dao(int _sname) throws Exception;

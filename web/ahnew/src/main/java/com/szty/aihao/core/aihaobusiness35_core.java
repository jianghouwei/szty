...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness35_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness35(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness35_Dao get_aihaobusiness35Dao(int _sname) throws Exception;

...
*@作者：宋春林 
*/
public class aihaoiptmp38_impl implements aihaoiptmp38_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp38_impl.class);
...
public int insert_aihaoiptmp38(aihaoiptmp38_Dao _AIHAOIPTMP38Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP38_PRO.InsertAIHAOIPTMP38(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP38Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP38Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP38Model.getY());
...
public int update_aihaoiptmp38(aihaoiptmp38_Dao _AIHAOIPTMP38Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP38_PRO.UpdateAIHAOIPTMP38(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP38Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP38Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP38Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp38(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP38_PRO.DeleteAIHAOIPTMP38(?)}";
...
public aihaoiptmp38_Dao get_aihaoiptmp38Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP38_PRO.GetAIHAOIPTMP38Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp38_Dao _obj = new aihaoiptmp38_Dao();
...
public List<aihaoiptmp38_Dao> get_aihaoiptmp38_All() throws Exception{
        List<aihaoiptmp38_Dao> _list = new ArrayList<aihaoiptmp38_Dao>();
		String sqlStr = "{ call AIHAOIPTMP38_PRO.GetAIHAOIPTMP38(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp38_Dao> get_aihaoiptmp38_All(String strWhere) throws Exception{
         List<aihaoiptmp38_Dao> _list = new ArrayList<aihaoiptmp38_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP38_PRO.GetAIHAOIPTMP38Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp38_Dao> get_aihaoiptmp38_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp38_Dao> _list = new ArrayList<aihaoiptmp38_Dao>();
		String sqlStr = "{ call AIHAOIPTMP38_PRO.GetAIHAOIPTMP38Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp38_Dao> get_aihaoiptmp38_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp38strWhere") == null) {
			Dictionary<Integer, aihaoiptmp38_Dao> _dic = new Hashtable<Integer, aihaoiptmp38_Dao>();
			List<aihaoiptmp38_Dao> _list = new ArrayList<aihaoiptmp38_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp38", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp38_Dao> _dic = (Dictionary<Integer, aihaoiptmp38_Dao>) classFactory
					.cacheGet("dicaihaoiptmp38strWhere");
...
public int create_aihaoiptmp38_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP38_PRO.UpdateFieldAIHAOIPTMP38(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP38_PRO.UpdateFieldAIHAOIPTMP38V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP38_PRO.UpdateFieldAIHAOIPTMP38U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

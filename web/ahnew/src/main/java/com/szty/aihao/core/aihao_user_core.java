...
import java.util.List;
    ...
    */
	...
	public interface aihao_user_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao_user(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao_user_Dao get_aihao_userDao(int _id) throws Exception;

 ...
 *@文件： mvnforumofflinemessagebackEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@MVNFORUMOFFLINEMESSAGEBACK数据实体
    *@作者：宋春林 
    */

	public class mvnforumofflinemessageback_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(mvnforumofflinemessageback_Dao _dao){

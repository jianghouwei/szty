...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness38_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness38(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness38_Dao get_aihaobusiness38Dao(int _sname) throws Exception;

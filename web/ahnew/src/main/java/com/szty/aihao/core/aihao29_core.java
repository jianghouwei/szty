...
import java.util.List;
    ...
    */
	...
	public interface aihao29_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao29(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao29_Dao get_aihao29Dao(int _id) throws Exception;

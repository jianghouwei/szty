...
*@作者：宋春林 
*/
public class test_qy_app_6001_impl implements test_qy_app_6001_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(test_qy_app_6001_impl.class);
...
public int insert_test_qy_app_6001(test_qy_app_6001_Dao _TEST_QY_APP_6001Model)  throws Exception{
         String sqlStr = "{call TEST_QY_APP_6001_PRO.InsertTEST_QY_APP_6001(?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[4];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_TEST_QY_APP_6001Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TEST_QY_APP_6001Model.getSn());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NUMERIC,_TEST_QY_APP_6001Model.getNum());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TEST_QY_APP_6001Model.getSd());
...
public int update_test_qy_app_6001(test_qy_app_6001_Dao _TEST_QY_APP_6001Model)  throws Exception{
        String sqlStr = "{call TEST_QY_APP_6001_PRO.UpdateTEST_QY_APP_6001(?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[4];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NUMERIC,_TEST_QY_APP_6001Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TEST_QY_APP_6001Model.getSn());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NUMERIC,_TEST_QY_APP_6001Model.getNum());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TEST_QY_APP_6001Model.getSd());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
...
public int delete_test_qy_app_6001(int Id)  throws Exception{
        String sqlStr = "{call TEST_QY_APP_6001_PRO.DeleteTEST_QY_APP_6001(?)}";
...
public test_qy_app_6001_Dao get_test_qy_app_6001Dao(int Id) throws Exception{
         String sqlStr = "{ call TEST_QY_APP_6001_PRO.GetTEST_QY_APP_6001Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			test_qy_app_6001_Dao _obj = new test_qy_app_6001_Dao();
...
public List<test_qy_app_6001_Dao> get_test_qy_app_6001_All() throws Exception{
        List<test_qy_app_6001_Dao> _list = new ArrayList<test_qy_app_6001_Dao>();
		String sqlStr = "{ call TEST_QY_APP_6001_PRO.GetTEST_QY_APP_6001(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< test_qy_app_6001_Dao> get_test_qy_app_6001_All(String strWhere) throws Exception{
         List<test_qy_app_6001_Dao> _list = new ArrayList<test_qy_app_6001_Dao>();
		 String sqlStr = "{ call TEST_QY_APP_6001_PRO.GetTEST_QY_APP_6001Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<test_qy_app_6001_Dao> get_test_qy_app_6001_Page(int pageSize, int pageIndex,
		...
		List<test_qy_app_6001_Dao> _list = new ArrayList<test_qy_app_6001_Dao>();
		String sqlStr = "{ call TEST_QY_APP_6001_PRO.GetTEST_QY_APP_6001Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, test_qy_app_6001_Dao> get_test_qy_app_6001_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dictest_qy_app_6001strWhere") == null) {
			Dictionary<Integer, test_qy_app_6001_Dao> _dic = new Hashtable<Integer, test_qy_app_6001_Dao>();
			List<test_qy_app_6001_Dao> _list = new ArrayList<test_qy_app_6001_Dao>();
			for (int i = 0; i < _list.size(); i++) {
                _dic.put((_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dictest_qy_app_6001", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, test_qy_app_6001_Dao> _dic = (Dictionary<Integer, test_qy_app_6001_Dao>) classFactory
					.cacheGet("dictest_qy_app_6001strWhere");
...
public int create_test_qy_app_6001_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call TEST_QY_APP_6001_PRO.UpdateFieldTEST_QY_APP_6001(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call TEST_QY_APP_6001_PRO.UpdateFieldTEST_QY_APP_6001V(?,?,?)}";
...
{
        String sqlStr = "{ call TEST_QY_APP_6001_PRO.UpdateFieldTEST_QY_APP_6001U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

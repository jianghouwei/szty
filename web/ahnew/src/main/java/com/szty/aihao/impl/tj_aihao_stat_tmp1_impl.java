...
*@文件： dataTj_aihao_stat_tmp1.java
*@项目名称：JAVA项目管理 
*@创建时间：2015/10/15
*@===================================================================
*/
...
*@作者：宋春林 
*/
public class tj_aihao_stat_tmp1_impl implements tj_aihao_stat_tmp1_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(tj_aihao_stat_tmp1_impl.class);
...
public int insert_tj_aihao_stat_tmp1(tj_aihao_stat_tmp1_Dao _TJ_AIHAO_STAT_TMP1Model)  throws Exception{
         String sqlStr = "{call TJ_AIHAO_STAT_TMP1_PRO.InsertTJ_AIHAO_STAT_TMP1(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_TJ_AIHAO_STAT_TMP1Model.getCdate());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getOs());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getChannel());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getVer());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getImsi());
...
public int update_tj_aihao_stat_tmp1(tj_aihao_stat_tmp1_Dao _TJ_AIHAO_STAT_TMP1Model)  throws Exception{
        String sqlStr = "{call TJ_AIHAO_STAT_TMP1_PRO.UpdateTJ_AIHAO_STAT_TMP1(?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[5];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getCdate());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getOs());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getChannel());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getVer());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_TJ_AIHAO_STAT_TMP1Model.getImsi());
...
public int delete_tj_aihao_stat_tmp1(int Cdate)  throws Exception{
        String sqlStr = "{call TJ_AIHAO_STAT_TMP1_PRO.DeleteTJ_AIHAO_STAT_TMP1(?)}";
...
public tj_aihao_stat_tmp1_Dao get_tj_aihao_stat_tmp1Dao(int Cdate) throws Exception{
         String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.GetTJ_AIHAO_STAT_TMP1Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Cdate);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			tj_aihao_stat_tmp1_Dao _obj = new tj_aihao_stat_tmp1_Dao();
...
public List<tj_aihao_stat_tmp1_Dao> get_tj_aihao_stat_tmp1_All() throws Exception{
        List<tj_aihao_stat_tmp1_Dao> _list = new ArrayList<tj_aihao_stat_tmp1_Dao>();
		String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.GetTJ_AIHAO_STAT_TMP1(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< tj_aihao_stat_tmp1_Dao> get_tj_aihao_stat_tmp1_All(String strWhere) throws Exception{
         List<tj_aihao_stat_tmp1_Dao> _list = new ArrayList<tj_aihao_stat_tmp1_Dao>();
		 String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.GetTJ_AIHAO_STAT_TMP1Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<tj_aihao_stat_tmp1_Dao> get_tj_aihao_stat_tmp1_Page(int pageSize, int pageIndex,
		...
		List<tj_aihao_stat_tmp1_Dao> _list = new ArrayList<tj_aihao_stat_tmp1_Dao>();
		String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.GetTJ_AIHAO_STAT_TMP1Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, tj_aihao_stat_tmp1_Dao> get_tj_aihao_stat_tmp1_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dictj_aihao_stat_tmp1strWhere") == null) {
			Dictionary<Integer, tj_aihao_stat_tmp1_Dao> _dic = new Hashtable<Integer, tj_aihao_stat_tmp1_Dao>();
			List<tj_aihao_stat_tmp1_Dao> _list = new ArrayList<tj_aihao_stat_tmp1_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getCdate()), _list.get(i));
			}
			classFactory.cachePut("dictj_aihao_stat_tmp1", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, tj_aihao_stat_tmp1_Dao> _dic = (Dictionary<Integer, tj_aihao_stat_tmp1_Dao>) classFactory
					.cacheGet("dictj_aihao_stat_tmp1strWhere");
...
public int create_tj_aihao_stat_tmp1_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.UpdateFieldTJ_AIHAO_STAT_TMP1(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.UpdateFieldTJ_AIHAO_STAT_TMP1V(?,?,?)}";
...
{
        String sqlStr = "{ call TJ_AIHAO_STAT_TMP1_PRO.UpdateFieldTJ_AIHAO_STAT_TMP1U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp29_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp29(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp29_Dao get_aihaoiptmp29Dao(int _id) throws Exception;

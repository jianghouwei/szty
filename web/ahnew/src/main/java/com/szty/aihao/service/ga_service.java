...
import java.util.List;
    ...
    */
	...
	public class ga_service
	{
        public  ga_core _dal=classFactory.getga();
		...
		public int insert_ga (ga_Dao _GAModel )  throws Exception{
         return _dal.insert_ga( _GAModel);
		}
        ...
        return _dal.update_ga( _GAModel);
		}
        ...
        * @throws Exception 
		...
		public List<ga_Dao> get_ga_All(String strWhere) throws Exception{
            return _dal.get_ga_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<ga_Dao> get_ga_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_ga_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据GA返回的查询DataRow创建一个GAEntity对象
         * @param GA row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, ga_Dao> get_ga_Dictionary(String strWhere) throws Exception{
            return _dal.get_ga_Dictionary(strWhere);
            }
		 /**
         * 更新GA字段加一
         * @param FieldName
	    ...
	    public int create_ga_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_ga_UpdateIncreate( FieldName, sid);
            }
         /**
         * 更新GAInt型字段
         * @param FieldName
	    ...
	    public int create_ga_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_ga_UpdateInteger( FieldName, Num, sid);
            }
          /**
         * 更新GAIString型字段
         * @param FieldName
         ...
         * @param sid
         */
	    public int createga_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_ga_UpdateString( FieldName, Value, sid);
            }

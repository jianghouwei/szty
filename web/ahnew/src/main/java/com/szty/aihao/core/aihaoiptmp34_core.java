...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp34_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp34(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp34_Dao get_aihaoiptmp34Dao(int _id) throws Exception;

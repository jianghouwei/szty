...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp30_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp30(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp30_Dao get_aihaoiptmp30Dao(int _id) throws Exception;

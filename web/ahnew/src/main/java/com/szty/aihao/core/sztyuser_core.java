...
import java.util.List;
    ...
    */
	...
	public interface sztyuser_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_sztyuser(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public sztyuser_Dao get_sztyuserDao(int _id) throws Exception;

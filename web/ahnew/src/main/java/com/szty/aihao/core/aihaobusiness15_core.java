...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness15_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness15(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness15_Dao get_aihaobusiness15Dao(int _sname) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface mvnforumembeddedpage_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumembeddedpage(int _embid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumembeddedpage_Dao get_mvnforumembeddedpageDao(int _embid) throws Exception;

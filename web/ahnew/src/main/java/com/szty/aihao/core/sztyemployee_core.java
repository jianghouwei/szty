...
import java.util.List;
    ...
    */
	...
	public interface sztyemployee_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_sztyemployee(int _eid) throws Exception;
        ...
        * @throws Exception 
         */
		public sztyemployee_Dao get_sztyemployeeDao(int _eid) throws Exception;

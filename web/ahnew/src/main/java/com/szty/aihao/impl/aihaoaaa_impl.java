...
*@作者：宋春林 
*/
public class aihaoaaa_impl implements aihaoaaa_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoaaa_impl.class);
...
public int insert_aihaoaaa(aihaoaaa_Dao _AIHAOAAAModel)  throws Exception{
         String sqlStr = "{call AIHAOAAA_PRO.InsertAIHAOAAA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[51];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOAAAModel.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getName());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getTelno());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getAddress());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBranch_name());
        op[5]= new OracleParameter(6, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getShort_name());
        op[6]= new OracleParameter(7, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getIntroduction());
        op[7]= new OracleParameter(8, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getRecommendation());
        op[8]= new OracleParameter(9, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getFeature());
        op[9]= new OracleParameter(10, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getSpecial_offer());
        op[10]= new OracleParameter(11, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getStyle());
        op[11]= new OracleParameter(12, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getProvince_id());
        op[12]= new OracleParameter(13, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getCity_id());
        op[13]= new OracleParameter(14, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getDistrict_id());
        op[14]= new OracleParameter(15, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getTrade_id());
        op[15]= new OracleParameter(16, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getProvince_name());
        op[16]= new OracleParameter(17, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getCity_name());
        op[17]= new OracleParameter(18, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getDistrict_name());
        op[18]= new OracleParameter(19, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getTrade_name());
        op[19]= new OracleParameter(20, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getCreated_at());
        op[20]= new OracleParameter(21, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getUpdated_at());
        op[21]= new OracleParameter(22, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getService_mask());
        op[22]= new OracleParameter(23, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getX());
        op[23]= new OracleParameter(24, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getY());
        op[24]= new OracleParameter(25, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getLandmark());
        op[25]= new OracleParameter(26, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getRegion());
        op[26]= new OracleParameter(27, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getSource());
        op[27]= new OracleParameter(28, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getXy_level());
        op[28]= new OracleParameter(29, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getWeight());
        op[29]= new OracleParameter(30, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getIs_exist());
        op[30]= new OracleParameter(31, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getTag());
        op[31]= new OracleParameter(32, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getCategory());
        op[32]= new OracleParameter(33, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getPrice());
        op[33]= new OracleParameter(34, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getOpen_time());
        op[34]= new OracleParameter(35, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getOfficial_site());
        op[35]= new OracleParameter(36, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getWl_discount());
        op[36]= new OracleParameter(37, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBizcode());
        op[37]= new OracleParameter(38, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getStatus());
        op[38]= new OracleParameter(39, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getOwner());
        op[39]= new OracleParameter(40, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getCollector_id());
        op[40]= new OracleParameter(41, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getReview_count());
        op[41]= new OracleParameter(42, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getIs_disp());
        op[42]= new OracleParameter(43, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getAttributes());
        op[43]= new OracleParameter(44, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getLevelv());
        op[44]= new OracleParameter(45, "IN", java.sql.Types.NUMERIC,_AIHAOAAAModel.getRow_num());
        op[45]= new OracleParameter(46, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getGeohas());
        op[46]= new OracleParameter(47, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBaidux());
        op[47]= new OracleParameter(48, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBaiduy());
        op[48]= new OracleParameter(49, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBigclass());
        op[49]= new OracleParameter(50, "IN", java.sql.Types.NUMERIC,_AIHAOAAAModel.getYouxiannum());
        op[50]= new OracleParameter(51, "IN", java.sql.Types.NUMERIC,_AIHAOAAAModel.getShowstatus());
...
public int update_aihaoaaa(aihaoaaa_Dao _AIHAOAAAModel)  throws Exception{
        String sqlStr = "{call AIHAOAAA_PRO.UpdateAIHAOAAA(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
		 OracleParameter[] op = new OracleParameter[51];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getName());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getTelno());
        op[3]= new OracleParameter(4, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getAddress());
        op[4]= new OracleParameter(5, "IN", java.sql.Types.NVARCHAR,_AIHAOAAAModel.getBranch_name());
...
public int delete_aihaoaaa(int Id)  throws Exception{
        String sqlStr = "{call AIHAOAAA_PRO.DeleteAIHAOAAA(?)}";
...
public aihaoaaa_Dao get_aihaoaaaDao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOAAA_PRO.GetAIHAOAAAEntity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoaaa_Dao _obj = new aihaoaaa_Dao();
            ...
            _obj.setCreated_at(arr.getString("CREATED_AT"));
            _obj.setUpdated_at(arr.getString("UPDATED_AT"));
...
public List<aihaoaaa_Dao> get_aihaoaaa_All() throws Exception{
        List<aihaoaaa_Dao> _list = new ArrayList<aihaoaaa_Dao>();
		String sqlStr = "{ call AIHAOAAA_PRO.GetAIHAOAAA(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoaaa_Dao> get_aihaoaaa_All(String strWhere) throws Exception{
         List<aihaoaaa_Dao> _list = new ArrayList<aihaoaaa_Dao>();
		 String sqlStr = "{ call AIHAOAAA_PRO.GetAIHAOAAAWhere(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoaaa_Dao> get_aihaoaaa_Page(int pageSize, int pageIndex,
		...
		List<aihaoaaa_Dao> _list = new ArrayList<aihaoaaa_Dao>();
		String sqlStr = "{ call AIHAOAAA_PRO.GetAIHAOAAAPage(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoaaa_Dao> get_aihaoaaa_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoaaastrWhere") == null) {
			Dictionary<Integer, aihaoaaa_Dao> _dic = new Hashtable<Integer, aihaoaaa_Dao>();
			List<aihaoaaa_Dao> _list = new ArrayList<aihaoaaa_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoaaa", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoaaa_Dao> _dic = (Dictionary<Integer, aihaoaaa_Dao>) classFactory
					.cacheGet("dicaihaoaaastrWhere");
...
public int create_aihaoaaa_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOAAA_PRO.UpdateFieldAIHAOAAA(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOAAA_PRO.UpdateFieldAIHAOAAAV(?,?,?)}";
...
{
        String sqlStr = "{ call AIHAOAAA_PRO.UpdateFieldAIHAOAAAU(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

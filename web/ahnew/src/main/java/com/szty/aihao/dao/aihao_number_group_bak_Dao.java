 ...
 *@文件： aihao_number_group_bakEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAO_NUMBER_GROUP_BAK数据实体
    *@作者：宋春林 
    */

	public class aihao_number_group_bak_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihao_number_group_bak_Dao _dao){

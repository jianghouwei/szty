...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp18_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp18(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp18_Dao get_aihaoiptmp18Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness28_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness28(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness28_Dao get_aihaobusiness28Dao(int _sname) throws Exception;

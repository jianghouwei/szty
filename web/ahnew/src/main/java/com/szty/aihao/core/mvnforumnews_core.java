...
import java.util.List;
    ...
    */
	...
	public interface mvnforumnews_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumnews(int _newsid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumnews_Dao get_mvnforumnewsDao(int _newsid) throws Exception;

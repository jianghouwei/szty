...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness39_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness39(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness39_Dao get_aihaobusiness39Dao(int _sname) throws Exception;

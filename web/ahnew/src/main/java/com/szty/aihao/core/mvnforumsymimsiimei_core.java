...
import java.util.List;
    ...
    */
	...
	public interface mvnforumsymimsiimei_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumsymimsiimei(int _imid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumsymimsiimei_Dao get_mvnforumsymimsiimeiDao(int _imid) throws Exception;

...
import java.util.List;
    ...
    /**
    *@文件说明
    *@AIHAO18_BAIDU_UPDATE逻辑层接口
    *@作者：宋春林 
    */

	public class aihao18_baidu_update_service
	{
        public  aihao18_baidu_update_core _dal=classFactory.getaihao18_baidu_update();
		...
		public int insert_aihao18_baidu_update (aihao18_baidu_update_Dao _AIHAO18_BAIDU_UPDATEModel )  throws Exception{
         return _dal.insert_aihao18_baidu_update( _AIHAO18_BAIDU_UPDATEModel);
		}
        ...
        return _dal.insert_aihao18_baidu_update( _para);
        }
        ...
        return _dal.update_aihao18_baidu_update( _AIHAO18_BAIDU_UPDATEModel);
		}
        ...
        return _dal.delete_aihao18_baidu_update( Nextval);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_aihao18_baidu_updateDao( Nextval);
		}
        ...
        * @throws Exception 
		...
		public List<aihao18_baidu_update_Dao> get_aihao18_baidu_update_All() throws Exception{
            return _dal.get_aihao18_baidu_update_All();
            }
		    /**
         * 根据AIHAO18_BAIDU_UPDATE返回的查询DataRow创建一个AIHAO18_BAIDU_UPDATEEntity对象
         * @param AIHAO18_BAIDU_UPDATE row
        ...
        * @throws Exception 
		...
		public List<aihao18_baidu_update_Dao> get_aihao18_baidu_update_All(String strWhere) throws Exception{
            return _dal.get_aihao18_baidu_update_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<aihao18_baidu_update_Dao> get_aihao18_baidu_update_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_aihao18_baidu_update_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据AIHAO18_BAIDU_UPDATE返回的查询DataRow创建一个AIHAO18_BAIDU_UPDATEEntity对象
         * @param AIHAO18_BAIDU_UPDATE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, aihao18_baidu_update_Dao> get_aihao18_baidu_update_Dictionary(String strWhere) throws Exception{
            return _dal.get_aihao18_baidu_update_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_aihao18_baidu_update_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_aihao18_baidu_update_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_aihao18_baidu_update_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_aihao18_baidu_update_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createaihao18_baidu_update_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_aihao18_baidu_update_UpdateString( FieldName, Value, sid);
            }

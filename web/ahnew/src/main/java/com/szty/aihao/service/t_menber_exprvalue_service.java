...
import java.util.List;
    ...
    /**
    *@文件说明
    *@T_MENBER_EXPRVALUE逻辑层接口
    *@作者：宋春林 
    */

	public class t_menber_exprvalue_service
	{
        public  t_menber_exprvalue_core _dal=classFactory.gett_menber_exprvalue();
		...
		public int insert_t_menber_exprvalue (t_menber_exprvalue_Dao _T_MENBER_EXPRVALUEModel )  throws Exception{
         return _dal.insert_t_menber_exprvalue( _T_MENBER_EXPRVALUEModel);
		}
        ...
        return _dal.insert_t_menber_exprvalue( _para);
        }
        ...
        return _dal.update_t_menber_exprvalue( _T_MENBER_EXPRVALUEModel);
		}
        ...
        return _dal.delete_t_menber_exprvalue( Uniquevalue);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_t_menber_exprvalueDao( Uniquevalue);
		}
        ...
        * @throws Exception 
		...
		public List<t_menber_exprvalue_Dao> get_t_menber_exprvalue_All() throws Exception{
            return _dal.get_t_menber_exprvalue_All();
            }
		    /**
         * 根据T_MENBER_EXPRVALUE返回的查询DataRow创建一个T_MENBER_EXPRVALUEEntity对象
         * @param T_MENBER_EXPRVALUE row
        ...
        * @throws Exception 
		...
		public List<t_menber_exprvalue_Dao> get_t_menber_exprvalue_All(String strWhere) throws Exception{
            return _dal.get_t_menber_exprvalue_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<t_menber_exprvalue_Dao> get_t_menber_exprvalue_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_t_menber_exprvalue_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据T_MENBER_EXPRVALUE返回的查询DataRow创建一个T_MENBER_EXPRVALUEEntity对象
         * @param T_MENBER_EXPRVALUE row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, t_menber_exprvalue_Dao> get_t_menber_exprvalue_Dictionary(String strWhere) throws Exception{
            return _dal.get_t_menber_exprvalue_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_t_menber_exprvalue_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_t_menber_exprvalue_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_t_menber_exprvalue_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_t_menber_exprvalue_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createt_menber_exprvalue_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_t_menber_exprvalue_UpdateString( FieldName, Value, sid);
            }

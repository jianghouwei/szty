...
import java.util.List;
    ...
    */
	...
	public interface twittercollect_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_twittercollect(int _collectid) throws Exception;
        ...
        * @throws Exception 
         */
		public twittercollect_Dao get_twittercollectDao(int _collectid) throws Exception;

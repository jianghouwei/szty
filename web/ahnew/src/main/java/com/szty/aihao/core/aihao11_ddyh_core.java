...
import java.util.List;
    ...
    */
	...
	public interface aihao11_ddyh_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihao11_ddyh(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihao11_ddyh_Dao get_aihao11_ddyhDao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaoppc_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoppc(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoppc_Dao get_aihaoppcDao(int _id) throws Exception;

...
import java.util.List;
    ...
    /**
    *@文件说明
    *@MVNFORUMBLOGREVIEW逻辑层接口
    *@作者：宋春林 
    */

	public class mvnforumblogreview_service
	{
        public  mvnforumblogreview_core _dal=classFactory.getmvnforumblogreview();
		...
		public int insert_mvnforumblogreview (mvnforumblogreview_Dao _MVNFORUMBLOGREVIEWModel )  throws Exception{
         return _dal.insert_mvnforumblogreview( _MVNFORUMBLOGREVIEWModel);
		}
        ...
        return _dal.insert_mvnforumblogreview( _para);
        }
        ...
        return _dal.update_mvnforumblogreview( _MVNFORUMBLOGREVIEWModel);
		}
        ...
        return _dal.delete_mvnforumblogreview( Reviewid);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_mvnforumblogreviewDao( Reviewid);
		}
        ...
        * @throws Exception 
		...
		public List<mvnforumblogreview_Dao> get_mvnforumblogreview_All() throws Exception{
            return _dal.get_mvnforumblogreview_All();
            }
		    /**
         * 根据MVNFORUMBLOGREVIEW返回的查询DataRow创建一个MVNFORUMBLOGREVIEWEntity对象
         * @param MVNFORUMBLOGREVIEW row
        ...
        * @throws Exception 
		...
		public List<mvnforumblogreview_Dao> get_mvnforumblogreview_All(String strWhere) throws Exception{
            return _dal.get_mvnforumblogreview_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<mvnforumblogreview_Dao> get_mvnforumblogreview_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_mvnforumblogreview_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据MVNFORUMBLOGREVIEW返回的查询DataRow创建一个MVNFORUMBLOGREVIEWEntity对象
         * @param MVNFORUMBLOGREVIEW row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, mvnforumblogreview_Dao> get_mvnforumblogreview_Dictionary(String strWhere) throws Exception{
            return _dal.get_mvnforumblogreview_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_mvnforumblogreview_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_mvnforumblogreview_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_mvnforumblogreview_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_mvnforumblogreview_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createmvnforumblogreview_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_mvnforumblogreview_UpdateString( FieldName, Value, sid);
            }

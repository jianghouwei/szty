...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness14_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness14(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness14_Dao get_aihaobusiness14Dao(int _sname) throws Exception;

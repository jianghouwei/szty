...
*@作者：宋春林 
*/
public class aihaoiptmp21_impl implements aihaoiptmp21_core
{
    	private static final Logger logger = LoggerFactory
			.getLogger(aihaoiptmp21_impl.class);
...
public int insert_aihaoiptmp21(aihaoiptmp21_Dao _AIHAOIPTMP21Model)  throws Exception{
         String sqlStr = "{call AIHAOIPTMP21_PRO.InsertAIHAOIPTMP21(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
         op[0] = new OracleParameter(1, "OUT", java.sql.Types.NUMERIC,_AIHAOIPTMP21Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP21Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP21Model.getY());
...
public int update_aihaoiptmp21(aihaoiptmp21_Dao _AIHAOIPTMP21Model)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP21_PRO.UpdateAIHAOIPTMP21(?,?,?)}";
		 OracleParameter[] op = new OracleParameter[3];
        op[0]= new OracleParameter(1, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP21Model.getId());
        op[1]= new OracleParameter(2, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP21Model.getX());
        op[2]= new OracleParameter(3, "IN", java.sql.Types.NVARCHAR,_AIHAOIPTMP21Model.getY());
		boolean result = OracleHelper.executeProcedure(sqlStr.toString(), op);
		if (result)
...
public int delete_aihaoiptmp21(int Id)  throws Exception{
        String sqlStr = "{call AIHAOIPTMP21_PRO.DeleteAIHAOIPTMP21(?)}";
...
public aihaoiptmp21_Dao get_aihaoiptmp21Dao(int Id) throws Exception{
         String sqlStr = "{ call AIHAOIPTMP21_PRO.GetAIHAOIPTMP21Entity(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		op[1] = new OracleParameter(2, "IN", java.sql.Types.NUMERIC, Id);
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
			aihaoiptmp21_Dao _obj = new aihaoiptmp21_Dao();
...
public List<aihaoiptmp21_Dao> get_aihaoiptmp21_All() throws Exception{
        List<aihaoiptmp21_Dao> _list = new ArrayList<aihaoiptmp21_Dao>();
		String sqlStr = "{ call AIHAOIPTMP21_PRO.GetAIHAOIPTMP21(?)}";
		OracleParameter[] op = new OracleParameter[1];
		op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
		OracleCachedRowSet arr = OracleHelper.executeQuery(sqlStr, op);
		while (arr.next()) {
...
public List< aihaoiptmp21_Dao> get_aihaoiptmp21_All(String strWhere) throws Exception{
         List<aihaoiptmp21_Dao> _list = new ArrayList<aihaoiptmp21_Dao>();
		 String sqlStr = "{ call AIHAOIPTMP21_PRO.GetAIHAOIPTMP21Where(?,?)}";
		 OracleParameter[] op = new OracleParameter[2];
		 op[0] = new OracleParameter(1, "OUT", OracleTypes.CURSOR, "");
...
public List<aihaoiptmp21_Dao> get_aihaoiptmp21_Page(int pageSize, int pageIndex,
		...
		List<aihaoiptmp21_Dao> _list = new ArrayList<aihaoiptmp21_Dao>();
		String sqlStr = "{ call AIHAOIPTMP21_PRO.GetAIHAOIPTMP21Page(?,?,?,?,?,?)}";
...
public Dictionary<Integer, aihaoiptmp21_Dao> get_aihaoiptmp21_Dictionary(String strWhere) throws Exception{
            if (classFactory.cacheGet("dicaihaoiptmp21strWhere") == null) {
			Dictionary<Integer, aihaoiptmp21_Dao> _dic = new Hashtable<Integer, aihaoiptmp21_Dao>();
			List<aihaoiptmp21_Dao> _list = new ArrayList<aihaoiptmp21_Dao>();
			for (int i = 0; i < _list.size(); i++) {
				_dic.put(Integer.parseInt(_list.get(i).getId()), _list.get(i));
			}
			classFactory.cachePut("dicaihaoiptmp21", _dic);
			System.out.println("from db");
			return _dic;
		} else {
			@SuppressWarnings("unchecked")
			Dictionary<Integer, aihaoiptmp21_Dao> _dic = (Dictionary<Integer, aihaoiptmp21_Dao>) classFactory
					.cacheGet("dicaihaoiptmp21strWhere");
...
public int create_aihaoiptmp21_UpdateIncreate(String FieldName,int sid)  throws Exception{
	    String sqlStr = "{ call AIHAOIPTMP21_PRO.UpdateFieldAIHAOIPTMP21(?,?)}";
		OracleParameter[] op = new OracleParameter[2];
...
{
		String sqlStr = "{ call AIHAOIPTMP21_PRO.UpdateFieldAIHAOIPTMP21V(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);
...
{
        String sqlStr = "{ call AIHAOIPTMP21_PRO.UpdateFieldAIHAOIPTMP21U(?,?,?)}";
		OracleParameter[] op = new OracleParameter[3];
		op[0] = new OracleParameter(1, "IN", OracleTypes.NUMBER, sid);
		op[1] = new OracleParameter(2, "IN", OracleTypes.VARCHAR, FieldName);

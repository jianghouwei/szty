...
import java.util.List;
    ...
    /**
    *@文件说明
    *@TMP_DZ_121008_WM_ME逻辑层接口
    *@作者：宋春林 
    */

	public class tmp_dz_121008_wm_me_service
	{
        public  tmp_dz_121008_wm_me_core _dal=classFactory.gettmp_dz_121008_wm_me();
		...
		public int insert_tmp_dz_121008_wm_me (tmp_dz_121008_wm_me_Dao _TMP_DZ_121008_WM_MEModel )  throws Exception{
         return _dal.insert_tmp_dz_121008_wm_me( _TMP_DZ_121008_WM_MEModel);
		}
        ...
        return _dal.insert_tmp_dz_121008_wm_me( _para);
        }
        ...
        return _dal.update_tmp_dz_121008_wm_me( _TMP_DZ_121008_WM_MEModel);
		}
        ...
        return _dal.delete_tmp_dz_121008_wm_me( P1);
		}
        ...
        * @throws Exception 
        ...
        return _dal.get_tmp_dz_121008_wm_meDao( P1);
		}
        ...
        * @throws Exception 
		...
		public List<tmp_dz_121008_wm_me_Dao> get_tmp_dz_121008_wm_me_All() throws Exception{
            return _dal.get_tmp_dz_121008_wm_me_All();
            }
		    /**
         * 根据TMP_DZ_121008_WM_ME返回的查询DataRow创建一个TMP_DZ_121008_WM_MEEntity对象
         * @param TMP_DZ_121008_WM_ME row
        ...
        * @throws Exception 
		...
		public List<tmp_dz_121008_wm_me_Dao> get_tmp_dz_121008_wm_me_All(String strWhere) throws Exception{
            return _dal.get_tmp_dz_121008_wm_me_All(strWhere);
            } 
     /* 根据SCLTEST返回 分页数据
	 * 
	 * @param SCLTEST
	 ...
	 * @throws Exception
	 */
	public List<tmp_dz_121008_wm_me_Dao> get_tmp_dz_121008_wm_me_Page(int pageSize, int pageIndex,String strWhere) throws Exception 
            {
                return _dal.get_tmp_dz_121008_wm_me_Page(pageSize,pageIndex,strWhere);
            }
           /**
         * 根据TMP_DZ_121008_WM_ME返回的查询DataRow创建一个TMP_DZ_121008_WM_MEEntity对象
         * @param TMP_DZ_121008_WM_ME row
        ...
        * @throws Exception 
        ...
        public Dictionary<Integer, tmp_dz_121008_wm_me_Dao> get_tmp_dz_121008_wm_me_Dictionary(String strWhere) throws Exception{
            return _dal.get_tmp_dz_121008_wm_me_Dictionary(strWhere);
            }
		 /**
	    ...
	    public int create_tmp_dz_121008_wm_me_UpdateIncreate(String FieldName,int sid)  throws Exception{
            return _dal.create_tmp_dz_121008_wm_me_UpdateIncreate( FieldName, sid);
            }
         /**
	    ...
	    public int create_tmp_dz_121008_wm_me_UpdateInteger(String FieldName,int Num,int sid)  throws Exception{
            return _dal.create_tmp_dz_121008_wm_me_UpdateInteger( FieldName, Num, sid);
            }
          /**
         ...
         * @param sid
         */
	    public int createtmp_dz_121008_wm_me_UpdateString(String FieldName,String Value,int sid)  throws Exception{
            
            return _dal.create_tmp_dz_121008_wm_me_UpdateString( FieldName, Value, sid);
            }

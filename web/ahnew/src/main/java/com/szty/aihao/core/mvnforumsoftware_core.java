...
import java.util.List;
    ...
    */
	...
	public interface mvnforumsoftware_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumsoftware(int _softwareid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumsoftware_Dao get_mvnforumsoftwareDao(int _softwareid) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface mvnforumgrouppermission_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_mvnforumgrouppermission(int _groupid) throws Exception;
        ...
        * @throws Exception 
         */
		public mvnforumgrouppermission_Dao get_mvnforumgrouppermissionDao(int _groupid) throws Exception;

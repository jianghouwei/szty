...
import java.util.List;
    ...
    */
	...
	public interface sztypurview_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_sztypurview(int _purid) throws Exception;
        ...
        * @throws Exception 
         */
		public sztypurview_Dao get_sztypurviewDao(int _purid) throws Exception;

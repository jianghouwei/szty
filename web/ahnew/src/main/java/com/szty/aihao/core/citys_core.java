...
import java.util.List;
    ...
    */
	...
	public interface citys_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_citys(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public citys_Dao get_citysDao(int _id) throws Exception;

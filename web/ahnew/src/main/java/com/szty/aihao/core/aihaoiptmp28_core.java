...
import java.util.List;
    ...
    */
	...
	public interface aihaoiptmp28_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaoiptmp28(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaoiptmp28_Dao get_aihaoiptmp28Dao(int _id) throws Exception;

...
import java.util.List;
    ...
    */
	...
	public interface aihaobusiness30_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_aihaobusiness30(int _sname) throws Exception;
        ...
        * @throws Exception 
         */
		public aihaobusiness30_Dao get_aihaobusiness30Dao(int _sname) throws Exception;

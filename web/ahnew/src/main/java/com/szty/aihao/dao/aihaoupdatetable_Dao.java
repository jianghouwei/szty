 ...
 *@文件： aihaoupdatetableEntity.java
 *@项目名称：JAVA项目管理
 *@创建时间：2015/10/15
 *@===================================================================
 */
...
import java.util.Date;
    /**
    *@文件说明
    *@AIHAOUPDATETABLE数据实体
    *@作者：宋春林 
    */

	public class aihaoupdatetable_Dao implements Serializable
	{
      ...
      /*  public static aihao_dao convert(aihaoupdatetable_Dao _dao){
        ...
        temp.setData_flag(_dao.getData_flag());
        
        temp.setAdd_time(_dao.getAdd_time());
        
        temp.setAuto_id(_dao.getAuto_id());

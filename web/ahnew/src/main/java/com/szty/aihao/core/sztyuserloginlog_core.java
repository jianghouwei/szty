...
import java.util.List;
    ...
    */
	...
	public interface sztyuserloginlog_core extends Serializable 
	{
         ...
         * @return 新插入记录的编号
         */
		public int delete_sztyuserloginlog(int _id) throws Exception;
        ...
        * @throws Exception 
         */
		public sztyuserloginlog_Dao get_sztyuserloginlogDao(int _id) throws Exception;

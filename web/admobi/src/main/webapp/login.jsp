...
<!-- The styles -->
<link id="bs-css" href="charisma/css/bootstrap-cerulean.min.css"
	rel="stylesheet">
<link href="charisma/css/charisma-app.css" rel="stylesheet">
<link
	href='charisma/bower_components/fullcalendar/dist/fullcalendar.css'
	rel='stylesheet'>
<link
	href='charisma/bower_components/fullcalendar/dist/fullcalendar.print.css'
	rel='stylesheet' media='print'>
<link href='charisma/bower_components/chosen/chosen.min.css'
	rel='stylesheet'>
<link href='charisma/bower_components/colorbox/example3/colorbox.css'
	rel='stylesheet'>
<link
	href='charisma/bower_components/responsive-tables/responsive-tables.css'
	rel='stylesheet'>
<link
	href='charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css'
	rel='stylesheet'>
...
<body>
						...
						<fieldset>
							<div class="input-group input-group-lg">
								<span class="input-group-addon"><i
									...
									class="form-control" placeholder="用户名" id="j_username"
									name="j_username">
							</div>
							...
							<div class="input-prepend">
								...
								<input type="checkbox" id="remember" id="_spring_security_remember_me" name="_spring_security_remember_me">记住密码</label>
							</div>
							<div class="clearfix"></div>
	...
	<script
		src="../charisma/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
	...
	<script
		src="../charisma/bower_components/colorbox/jquery.colorbox-min.js"></script>
	<!-- notification plugin -->
	<script src="../charisma/js/jquery.noty.js"></script>
	<!-- library for making tables responsive -->
	<script
		src="../charisma/bower_components/responsive-tables/responsive-tables.js"></script>
	<!-- tour plugin -->
	<script
		src="../charisma/bower_components/bootstrap-tour/build/js/bootstrap-tour.min.js"></script>
	<!-- star rating plugin -->

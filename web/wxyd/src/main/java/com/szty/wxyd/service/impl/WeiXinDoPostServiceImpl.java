...
import com.szty.wxyd.util.Base64;
import com.szty.wxyd.util.MenuClickUtil;
import com.szty.wxyd.util.MessageUtil;

/**
 * 
 * @ClassName: WeiXinDoPostServiceImpl
 * @Description: TODO(微信回调处理类)
 * @author mao.ru
 * @date 2016年1月13日 上午11:01:50
 *
 */
@Service
public class WeiXinDoPostServiceImpl implements WeiXinDoPostService {
	...
	public String getTextMessageModel(String msg, Map<String, String> map) {
		...
		String text = MessageUtil.textMessageToXml(textMsg);
		return text;
	}
